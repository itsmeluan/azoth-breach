...
2. `AZOTH_01.1_Tratado_da_Alquimia_v0.2.md`
3. `AZOTH_01.2_Engenharia_dos_Circulos_v0.1.md`
4. `AZOTH_01.3_Taxonomia_das_Transmutacoes_v0.1.md`
5. `AZOTH_01.4_Pesquisa_Alquimica_v0.1.md`
6. `AZOTH_01.5_Academias_de_Alquimia_v0.1.md`
...
Deve descrever como a alquimia é estudada, descrita, ensinada e aplicada pelas civilizações, sem redefinir a MAA.
...
Método científico, validação e evolução da alquimia.

Deve descrever como descobertas, experimentos e validações alquímicas evoluem dentro dos limites da ciência incompleta do universo.
