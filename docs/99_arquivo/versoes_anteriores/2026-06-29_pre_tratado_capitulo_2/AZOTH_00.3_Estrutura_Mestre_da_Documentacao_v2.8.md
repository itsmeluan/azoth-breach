...
/docs
  /00_constituicao
    AZOTH_00.0_Leis_Fundamentais_v1.8.md
    AZOTH_00.1_The_Truth_v1.8_Constituicao_do_Universo.md
    AZOTH_00.2_Glossario_Canonico_v1.9.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.8.md
  /01_alquimia
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.7.md
    AZOTH_01.1_Tratado_da_Alquimia_v0.2.md
    AZOTH_01.2_Engenharia_dos_Circulos_v0.1.md
    AZOTH_01.3_Taxonomia_das_Transmutacoes_v0.1.md
    AZOTH_01.4_Pesquisa_Alquimica_v0.1.md
    AZOTH_01.5_Academias_de_Alquimia_v0.1.md
    README.md
  /02_lore
    README.md
  /03_narrativa
...
Abrange a Máquina Abstrata da Alquimia, o Tratado da Alquimia, Engenharia dos Círculos, Taxonomia das Transmutações, Pesquisa Alquímica, Academias de Alquimia, Linguagem Universal da Alquimia, Gramática Geométrica, Máquina de Execução, Incerteza Fundamental da Transmutação, Precisão Alquímica, Proficiência Alquímica, Complexidade Alquímica, física aplicada, sistemas de transmutação, materiais, energia, biomodificação, artefatos, pesquisa científica e documentos de engenharia de sistemas alquímicos.
...
5. 01.4 — Pesquisa Alquímica: método científico, validação e evolução da alquimia.
6. 01.5 — Academias de Alquimia: instituições, especializações e linhas de pesquisa.
...
| Futuro Tratado da Alquimia | `/docs/01_alquimia/AZOTH_01.1_Tratado_da_Alquimia_v0.2.md`, subordinado à MAA |
| 03 — História | `/docs/02_lore` |
| 04 — Compêndio das Academias | `/docs/02_lore` e `/docs/01_alquimia/AZOTH_01.5_Academias_de_Alquimia_v0.1.md` |
