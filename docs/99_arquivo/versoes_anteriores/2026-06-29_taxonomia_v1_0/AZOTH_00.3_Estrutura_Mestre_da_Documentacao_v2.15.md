...
/docs
  /00_constituicao
    ...
    AZOTH_00.2_Glossario_Canonico_v1.16.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.15.md
  /01_alquimia
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.7.md
    AZOTH_01.1_Tratado_da_Alquimia_v1.1.md
    AZOTH_01.2_Taxonomia_das_Transmutacoes_v0.3.md
    AZOTH_01.3_Academias_de_Alquimia_v0.3.md
    AZOTH_01.4_Pesquisa_Aplicada_e_Catalogacao_Alquimica_v0.1.md
    README.md
  /02_lore
    README.md
  /03_narrativa
...
3. 01.2 — Taxonomia das Transmutações: classificação formal das transmutações, operações e técnicas.
4. 01.3 — Academias de Alquimia: instituições, especializações, linhas de pesquisa e catalogação científica de ETs.
5. 01.4 — Pesquisa Aplicada e Catalogação Alquímica: aplicação institucional, validação, registro, preservação e compartilhamento de ETs após desenvolvimento das Academias.
...
| Tratado da Alquimia | `/docs/01_alquimia/AZOTH_01.1_Tratado_da_Alquimia_v1.1.md`, subordinado à MAA |
| 03 — História | `/docs/02_lore` |
| 04 — Compêndio das Academias | `/docs/02_lore` e `/docs/01_alquimia/AZOTH_01.3_Academias_de_Alquimia_v0.3.md` |
...
- 01.4 — Pesquisa Aplicada e Catalogação Alquímica deve permanecer subordinado ao Documento 01.3 — Academias de Alquimia e não deve ser expandido antes dele.
