...
/docs
  /00_constituicao
    ...
    AZOTH_00.2_Glossario_Canonico_v1.10.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.9.md
  /01_alquimia
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.7.md
    AZOTH_01.1_Tratado_da_Alquimia_v0.5.md
...
Abrange a Máquina Abstrata da Alquimia, o Tratado da Alquimia, Engenharia dos Círculos, Taxonomia das Transmutações, Pesquisa Alquímica, Academias de Alquimia, Linguagem Universal da Alquimia, Gramática Geométrica, Máquina de Execução, Incerteza Fundamental da Transmutação, Precisão Alquímica, Proficiência Alquímica, Complexidade Alquímica, ETs, física aplicada, sistemas de transmutação, materiais, energia, biomodificação, artefatos, pesquisa científica e documentos de engenharia de sistemas alquímicos.
...
| Tratado da Alquimia | `/docs/01_alquimia/AZOTH_01.1_Tratado_da_Alquimia_v0.5.md`, subordinado à MAA |
