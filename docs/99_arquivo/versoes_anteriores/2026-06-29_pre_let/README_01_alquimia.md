...
2. `AZOTH_01.1_Tratado_da_Alquimia_v0.8.md`
...
Ciência, engenharia, arquitetura das ETs e Teoria das Transmutações.

Deve descrever como a alquimia é estudada, descrita, ensinada e aplicada pelas civilizações, incluindo arquitetura, avaliação, evolução de ETs e teoria científica das transmutações, sem redefinir a MAA.
