...
/docs
  /00_constituicao
    AZOTH_00.0_Leis_Fundamentais_v1.9.md
    AZOTH_00.1_The_Truth_v1.9_Constituicao_do_Universo.md
    AZOTH_00.2_Glossario_Canonico_v1.15.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.14.md
  /01_alquimia
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.7.md
    AZOTH_01.1_Tratado_da_Alquimia_v1.0.md
    AZOTH_01.2_Engenharia_dos_Circulos_v0.1.md
    AZOTH_01.3_Taxonomia_das_Transmutacoes_v0.2.md
    AZOTH_01.4_Pesquisa_Alquimica_v0.2.md
    AZOTH_01.5_Academias_de_Alquimia_v0.2.md
    README.md
  /02_lore
    README.md
  /03_narrativa
...
Abrange a Máquina Abstrata da Alquimia, o Tratado da Alquimia, Engenharia dos Círculos, Taxonomia das Transmutações, Pesquisa Alquímica, Academias de Alquimia, Linguagem Universal da Alquimia, Linguagem das Especificações da Transmutação, Runas, Camadas da ET, Convenções de Engenharia Alquímica, Padrões de Engenharia Alquímica, Representação Gráfica da ET, Gramática Geométrica, Máquina de Execução, Incerteza Fundamental da Transmutação, Precisão Alquímica, Proficiência Alquímica, Complexidade Alquímica, Convergência Experimental, Arquitetura de ET, Complexidade da ET, Teoria das Transmutações, ETs, física aplicada, sistemas de transmutação, materiais, energia, biomodificação, artefatos, pesquisa científica e documentos de engenharia de sistemas alquímicos.
...
2. 01.1 — Tratado da Alquimia: ciência, engenharia, LET, runas, camadas, padrões, representação gráfica, arquitetura das ETs e Teoria das Transmutações.
3. 01.2 — Engenharia dos Círculos: projeto, otimização e composição de especificações.
4. 01.3 — Taxonomia das Transmutações: classificação formal das transmutações, operações e técnicas.
5. 01.4 — Pesquisa Alquímica: método científico, validação, Convergência Experimental e evolução da alquimia.
6. 01.5 — Academias de Alquimia: instituições, especializações, linhas de pesquisa e catalogação científica de ETs.
...
| Tratado da Alquimia | `/docs/01_alquimia/AZOTH_01.1_Tratado_da_Alquimia_v1.0.md`, subordinado à MAA |
| 03 — História | `/docs/02_lore` |
| 04 — Compêndio das Academias | `/docs/02_lore` e `/docs/01_alquimia/AZOTH_01.5_Academias_de_Alquimia_v0.2.md` |
...
- 01.1 a 01.5 devem derivar da MAA e não podem redefinir a arquitetura da transmutação.
