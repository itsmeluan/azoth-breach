...
/docs
  /00_constituicao
    ...
    AZOTH_00.2_Glossario_Canonico_v1.14.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.13.md
  /01_alquimia
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.7.md
    AZOTH_01.1_Tratado_da_Alquimia_v0.9.md
...
Abrange a Máquina Abstrata da Alquimia, o Tratado da Alquimia, Engenharia dos Círculos, Taxonomia das Transmutações, Pesquisa Alquímica, Academias de Alquimia, Linguagem Universal da Alquimia, Linguagem das Especificações da Transmutação, Gramática Geométrica, Máquina de Execução, Incerteza Fundamental da Transmutação, Precisão Alquímica, Proficiência Alquímica, Complexidade Alquímica, Convergência Experimental, Arquitetura de ET, Complexidade da ET, Teoria das Transmutações, ETs, física aplicada, sistemas de transmutação, materiais, energia, biomodificação, artefatos, pesquisa científica e documentos de engenharia de sistemas alquímicos.
...
2. 01.1 — Tratado da Alquimia: ciência, engenharia, LET, arquitetura das ETs e Teoria das Transmutações.
...
| Tratado da Alquimia | `/docs/01_alquimia/AZOTH_01.1_Tratado_da_Alquimia_v0.9.md`, subordinado à MAA |
