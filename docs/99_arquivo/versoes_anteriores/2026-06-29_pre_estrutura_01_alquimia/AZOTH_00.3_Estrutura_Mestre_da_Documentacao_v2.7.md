...
/docs
  /00_constituicao
    AZOTH_00.0_Leis_Fundamentais_v1.7.md
    AZOTH_00.1_The_Truth_v1.7_Constituicao_do_Universo.md
    AZOTH_00.2_Glossario_Canonico_v1.8.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.7.md
  /01_tratados_tecnicos
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.6.md
    README.md
  /02_lore
    README.md
  /03_narrativa
