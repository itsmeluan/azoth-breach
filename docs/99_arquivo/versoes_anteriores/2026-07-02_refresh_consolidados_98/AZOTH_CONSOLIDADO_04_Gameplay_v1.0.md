...
- `docs/04_gameplay/AZOTH_04.0_Arquitetura_do_Gameplay_v0.1.md`
- `docs/04_gameplay/AZOTH_04.1_Core_Loop_e_Estrutura_de_Progressao_v0.1.md`
- `docs/04_gameplay/AZOTH_04.2_Transmutacao_Como_Sistema_de_Jogo_v0.1.md`
- `docs/04_gameplay/AZOTH_04.3_Combate_Funcoes_Taticas_e_Resolucao_v0.1.md`
- `docs/04_gameplay/AZOTH_04.4_Exploracao_Mundo_Jogavel_e_Estruturas_de_Campo_v0.1.md`
- `docs/04_gameplay/AZOTH_04.5_Progressao_do_Jogador_Builds_e_Especializacao_v0.1.md`
- `docs/04_gameplay/AZOTH_04.6_Recursos_Crafting_Pesquisa_e_Economia_de_Sistemas_v0.1.md`
- `docs/04_gameplay/AZOTH_04.7_Coop_Competicao_e_Interacao_Multijogador_v0.1.md`
- `docs/04_gameplay/AZOTH_04.8_Interface_UX_e_Legibilidade_de_Gameplay_v1.0.md`
- `docs/04_gameplay/AZOTH_04.9_Codex_Investigacao_e_Narrativa_Jogavel_v1.0.md`
- `docs/04_gameplay/AZOTH_04.10_Balanceamento_Telemetria_e_Criterios_de_Validacao_v0.1.md`
...
Os arquivos ativos da pasta `04_gameplay` são:
...
10. `AZOTH_04.9_Codex_Investigacao_e_Narrativa_Jogavel_v1.0.md`  
    Define Codex Veritatis como sistema jogável, investigação, evidência, hipóteses, relatórios de campo, recontextualização de conhecimento e narrativa jogável como camada mecânica.

11. `AZOTH_04.10_Balanceamento_Telemetria_e_Criterios_de_Validacao_v0.1.md`  
    Define medição de experiência, tuning sistêmico, critérios de validação, alertas de saúde do jogo, guardrails de balanceamento e governança de ajustes.
...
- `04.9`: como conhecimento, investigação, evidência e narrativa se tornam progressão jogável?
- `04.10`: como o sistema é medido, testado, ajustado e mantido consistente ao longo do desenvolvimento?

## Regra de Escopo

O escopo ativo da pasta `04_gameplay` permanece restrito a esses arquivos.
...
<!-- INICIO: docs/04_gameplay/AZOTH_04.0_Arquitetura_do_Gameplay_v0.1.md -->
...
1. **Domínio** — matéria, energia, vida e informação, isoladamente ou em composição multidomínio compatível com a MAA.
2. **Operação** — conversão, reorganização, separação, síntese, transferência e estabilização, isoladamente ou em composição compatível com a MAA.
...
Esse sistema deve ser detalhado em `04.6` e balanceado em `04.10`.
...
<!-- FIM: docs/04_gameplay/AZOTH_04.0_Arquitetura_do_Gameplay_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.1_Core_Loop_e_Estrutura_de_Progressao_v0.1.md -->
# AZOTH: BREACH — Documento 04.1 — Core Loop e Estrutura de Progressão

## Documento de Loop, Ritmo e Progressão Sistêmica

**Série:** 04 — Gameplay  
**Código:** AZOTH_04.1  
**Título:** Core Loop e Estrutura de Progressão  
**Versão:** v0.1  
**Status:** Documento inicial consolidado  
**Documento anterior:** `AZOTH_04.0_Arquitetura_do_Gameplay_v0.1.md`  
**Função:** Definir o que o jogador faz repetidamente, por que continua jogando, como cada sessão se organiza, como campanha, grind, operações repetíveis, Codex, buildcraft e endgame se conectam, e como a progressão se manifesta sem violar o cânone de AZOTH: BREACH.

---

# 1. Função deste Documento

Este documento define a estrutura de loops e progressão de **AZOTH: BREACH**.

Ele aprofunda a visão estabelecida em `04.0 — Arquitetura do Gameplay`, transformando a definição high-level do jogo em uma estrutura jogável recorrente, clara e escalável.

Este documento responde às seguintes perguntas:

- o que o jogador faz repetidamente;
- como uma sessão curta funciona;
- como uma operação se estrutura;
- como o jogador progride em campanha, região, Academia, Codex, personagem, build e endgame;
- como missões narrativas e atividades repetíveis convivem;
- como o grind permanece sempre disponível sem quebrar a experiência narrativa;
- como o jogador sente recompensa, sorte, domínio mecânico e construção de identidade;
- como a progressão respeita os limites canônicos das séries `00`, `01`, `02` e `03`;
- quais sistemas dependem deste documento para serem detalhados nos documentos seguintes.

Este documento não define números finais, fórmulas de XP, drop rates, duração exata de temporadas, balanceamento ou interface final. Esses temas pertencem a documentos posteriores da série `04`, especialmente `04.5`, `04.6`, `04.8` e `04.10`.

A função do `04.1` é estrutural: definir a espinha dorsal da experiência.

---

# 2. Precedência Canônica

Toda progressão de gameplay deve respeitar a hierarquia documental do projeto:
...
- antecipar revelações bloqueadas pela série `03`;
- transformar o jogador em exceção às Leis Fundamentais;
- permitir transmutação fora da Máquina Abstrata da Alquimia;
- tratar Azoth como “mana genérica” ou fonte arbitrária de aleatoriedade;
- criar novos Domínios Fundamentais ou Operações Fundamentais;
- liberar conhecimento narrativo antes do regime correto de revelação;
- transformar endgame em vitória cósmica ou resolução definitiva do Véu;
- fazer loot raro quebrar conservação da massa-energia, LET, ETs, Código Geométrico ou Protocolo Flamel.

Gameplay pode abstrair, simplificar e ritmar o aprendizado desses conceitos, mas não pode contradizê-los.

---

# 3. Definição Operacional do Jogo

A definição operacional de AZOTH: BREACH para fins de loop e progressão é:

> **AZOTH: BREACH é um RPG tático narrativo de operações alquímicas em que o jogador escolhe missões, prepara equipe e ETs, entra em campo, resolve crises táticas e investigativas, coleta recursos e conhecimento, retorna à Academia, refina sua build e avança por campanha, grind e endgame.**

A experiência é construída sobre três grandes modos de continuidade:

1. **Campanha de Revelação**  
   Progressão narrativa, regional e institucional, com missões principais, marcos de revelação, personagens, decisões e recontextualização do mundo.

2. **Operações Repetíveis**  
   Grind permanente, sempre disponível, justificado por incidentes recorrentes de Breach, ruínas instáveis, demandas institucionais, extração de materiais, simulações e surtos regionais.

3. **Endgame de Colapso**  
   Atividades pós-campanha ou pós-marcos avançados, com Frentes de Colapso, temporadas, risco escalável, chase loot ultrarraro, builds avançadas e progressão de domínio.

Esses três modos não são jogos separados. Eles compartilham os mesmos fundamentos:
...
# 4. Princípio Central de Progressão

O princípio central de progressão é:

> **O jogador deve sentir que ficou mais capaz por esforço, conhecimento, experimentação, domínio das mecânicas e decisões de build, mas nunca deve sentir que rompeu os limites estruturais do universo.**

Em outras palavras:

- grind gera matéria-prima e oportunidades;
- conhecimento dá direção;
- crafting transforma recursos em possibilidades;
- teste de build gera domínio;
- missões difíceis validam a construção do jogador;
- campanha dá contexto e significado;
- Codex dá compreensão e novas leituras;
- endgame dá obsessão, raridade e continuidade.

O jogador deve pensar:

> “Eu fiquei mais forte porque entendi melhor o sistema, encontrei recursos raros, testei combinações e construí uma solução minha.”

Não deve pensar:

> “Eu fiquei mais forte porque o jogo me deu números maiores sem relação com minhas decisões.”

---

# 5. Macroestrutura da Experiência

A experiência completa deve ser organizada em camadas recorrentes.

## 5.1 Camada de Hub

O hub representa a base operacional do jogador, normalmente vinculada a uma Academia ou estrutura institucional equivalente.
...
- revisar relatórios;
- conduzir pesquisa;
- craftar e modificar componentes;
- conversar com personagens;
- acessar arquivos liberados;
- visualizar consequências regionais;
- receber incidentes repetíveis;
- iniciar Frentes de Colapso quando disponíveis.

O hub é o espaço de respiro, planejamento e transformação do progresso em capacidade.

## 5.2 Camada de Mapa

O mapa de Aletheia representa regiões, zonas instáveis, rotas, cidades, ruínas, Academias, áreas interditadas, Frentes de Colapso e pontos de interesse.

Funções do mapa:

- escolher destino;
- visualizar risco regional;
- visualizar estado das regiões;
- acessar missões principais;
- acessar operações repetíveis;
- ver incidentes temporários;
- identificar oportunidades de grind;
- acompanhar surtos de Breach;
- perceber consequências de decisões anteriores.

O mapa deve comunicar ao jogador que Aletheia é viva, instável e afetada por suas ações.

## 5.3 Camada de Operação

A operação é a unidade jogável principal.

Uma operação combina:

- objetivo;
- preparação;
- risco;
- eventos;
- combate ou resolução tática;
- investigação;
- coleta;
- decisão;
- recompensa;
...
Toda operação deve terminar com algum tipo de transformação de estado: do jogador, da build, do Codex, da região, da campanha, da Academia ou do inventário.

## 5.4 Camada de Retorno

Após uma operação, o jogador deve receber um retorno claro:
...
- reputação alterada;
- região afetada;
- novos incidentes desbloqueados;
- novas hipóteses no Codex;
- avanços de campanha;
- alertas de risco futuro;
- oportunidades de crafting.

O retorno é essencial para a sensação de recompensa.

## 5.5 Camada de Reconfiguração

Depois de receber recompensas, o jogador deve poder agir sobre elas.

Exemplos:

- equipar novo componente;
- refinar uma ET;
- trocar catalisador;
- testar runa modificadora;
- desbloquear entrada do Codex;
- abrir missão adicional;
- reconfigurar equipe;
- alterar estratégia regional;
- iniciar grind direcionado;
- tentar uma operação mais difícil.

Essa camada transforma recompensa em nova decisão.

---

# 6. Core Loop Principal

O core loop principal de AZOTH: BREACH é:

1. **Ler o estado do mundo**  
   O jogador observa mapa, hub, incidentes, campanha, Codex, recursos, build e objetivos disponíveis.

2. **Escolher uma operação**  
   O jogador decide entre avançar campanha, farmar recursos, investigar uma região, cumprir demanda institucional, testar build, buscar loot raro ou enfrentar conteúdo de risco.

3. **Preparar equipe e loadout**  
   O jogador escolhe agentes, ETs, modificadores, catalisadores, instrumentos e estratégia.

4. **Executar a operação**  
   O jogador enfrenta eventos narrativos, escolhas, investigação, combate tático, contenção, extração e riscos de Breach.

5. **Coletar resultados**  
   O jogador obtém recursos, conhecimento, loot, fragmentos, amostras, reputação, progresso de Codex e consequências.

6. **Interpretar consequências**  
   O jogador entende o que mudou: região, Academia, campanha, build, Codex, risco ou oportunidades.

7. **Refinar capacidade**  
   O jogador crafta, pesquisa, equipa, melhora, substitui, testa e especializa.

8. **Escolher novo objetivo**  
   O jogador decide se avança a história, faz grind, busca loot específico, testa outra build ou aceita risco maior.

A forma resumida do loop é:

> **Observar → Escolher → Preparar → Operar → Coletar → Interpretar → Refinar → Recomeçar.**

Esse loop deve funcionar tanto para campanha quanto para grind e endgame.

---

# 7. Loop de Sessão Curta

Uma sessão curta deve funcionar em aproximadamente **5 a 15 minutos**.

A experiência mínima satisfatória deve ser:

1. abrir hub ou mapa;
2. identificar uma atividade útil;
3. preparar ou confirmar loadout;
4. entrar em uma operação curta;
5. resolver um confronto, evento ou objetivo;
6. obter recompensa;
7. ver algum progresso tangível;
8. sair satisfeito ou iniciar outra operação.

Uma sessão curta deve sempre oferecer ao jogador ao menos uma das seguintes recompensas:

- recurso útil;
- fragmento de ET;
- amostra;
- avanço de Codex;
- loot comum, incomum ou raro;
- avanço de reputação;
- progresso em objetivo diário/sazonal;
- melhora de proficiência;
- informação nova;
- abertura de nova oportunidade.

Mesmo quando o jogador não obtiver o loot desejado, a sessão não deve parecer perdida.

A regra é:

> **Toda operação deve gerar progresso, mesmo quando não gera sorte.**

---

# 8. Loop de Operação

A operação é a principal unidade de gameplay.

## 8.1 Estrutura Padrão de Operação

Uma operação padrão deve seguir esta sequência:

1. **Briefing**  
   Contexto, objetivo, risco estimado, região, restrições e recompensas possíveis.

2. **Preparação**  
   Escolha de equipe, ETs, catalisadores, instrumentos, consumíveis e abordagem.

3. **Entrada em Campo**  
   Apresentação do ambiente, estado inicial da zona e variáveis de risco.

4. **Desenvolvimento**  
   Eventos narrativos, exploração curta, combate, investigação, coleta ou escolhas.

5. **Crise Tática**  
   Momento de pressão: confronto, expansão de Breach, falha de contenção, resgate, colapso, decisão moral ou extração.

6. **Resolução**  
   Sucesso, sucesso parcial, falha controlada, retirada, colapso ou consequência.

7. **Extração/Encerramento**  
   Saída da operação, consolidação de ganhos e perdas.

8. **Relatório**  
   Recompensas, consequências, alterações de Codex, região, reputação e próximos passos.

## 8.2 Operações Curtas

Operações curtas devem ser usadas para:
...
- objetivos diários/sazonais.

Elas devem ter baixa fricção e retorno rápido.

## 8.3 Operações Médias

Operações médias devem ser usadas para:

- missões secundárias relevantes;
- investigações regionais;
- exploração de ruínas pequenas;
- progressão de personagem;
- desbloqueios de Codex;
- operações de campanha intermediárias.

Elas devem combinar evento, combate e decisão.

## 8.4 Operações Longas

Operações longas devem ser reservadas para:

- missões principais;
- ruínas importantes;
- marcos de campanha;
- operações de revelação;
- Frentes de Colapso profundas;
- finais de arco regional.

Elas podem envolver múltiplas etapas, risco acumulado e consequências maiores.

## 8.5 Resultado Não Binário

Operações não devem ser apenas “vitória” ou “derrota”.
...
- colapso controlado;
- falha crítica;
- conclusão narrativa sem controle total.

Mesmo uma falha pode gerar conhecimento, Codex, materiais danificados, alertas regionais ou desbloqueios de hipótese.

---

# 9. Loop de Campanha

A campanha é o eixo de revelação memorável.

O loop de campanha é:

1. receber missão ou pista principal;
2. investigar região, personagem, ruína ou fenômeno;
3. completar operações conectadas;
4. encontrar contradição ou evidência;
5. atualizar Codex e interpretação;
6. desbloquear nova missão, região ou permissão;
7. tomar decisão com consequência;
8. avançar para novo marco narrativo.

A campanha deve entregar:

- revelações graduais;
- mudanças de regime de conhecimento;
- progressão regional;
- envolvimento com Academias;
- personagens memoráveis;
- missões de alto impacto;
- recontextualização de eventos anteriores;
- transição orgânica para endgame.

A campanha não deve bloquear o jogador em uma trilha única sem atividades paralelas.

A qualquer momento apropriado, o jogador deve poder alternar entre:
...
# 10. Loop de Grind Permanente

O grind permanente é obrigatório para a experiência de AZOTH: BREACH.

Sua função é garantir que o jogador sempre tenha uma atividade útil, repetível e recompensadora disponível.

## 10.1 Justificativa no Universo

O grind existe porque Aletheia é instável.

Breaches, incidentes, ecos, ruínas, surtos e anomalias não são eventos únicos. Eles se repetem, se deslocam, reverberam e deixam resíduos.

Atividades repetíveis podem ser justificadas como:
...
- ecos alquímicos;
- surtos de Ruído Informacional;
- demandas de contenção das Academias;
- rotas comerciais sob risco;
- simulações acadêmicas;
- protocolos de treinamento;
- extração controlada de materiais;
- resposta a criaturas deslocadas;
- reabertura parcial de áreas já visitadas.

O grind não é uma concessão artificial. Ele é uma consequência jogável do estado do mundo.

## 10.2 Quadro de Incidentes

O principal sistema de grind durante a campanha deve ser o **Quadro de Incidentes**.

O Quadro de Incidentes apresenta operações repetíveis, rotativas ou semi-rotativas, como:

- conter fissura menor;
- recuperar amostra em zona instável;
- escoltar pesquisador;
- eliminar criatura deslocada;
- auditar oficina alquímica;
- estabilizar rota comercial;
- investigar eco em ruína;
- extrair catalisador;
- testar ET em campo controlado;
- responder a pedido emergencial;
- simular cenário tático;
- limpar contaminação residual.

O Quadro de Incidentes deve oferecer atividades de diferentes durações e riscos.

## 10.3 Recompensas do Grind

O grind deve poder conceder:
...
- moeda ou recurso operacional;
- progresso de Codex;
- padrões visuais;
- chance baixa de loot raro.

O grind deve criar a sensação:

> “Talvez na próxima operação venha aquele componente que muda minha build.”

## 10.4 Grind Sem Frustração Excessiva

O jogador pode não obter o item raro desejado, mas deve sempre avançar em algo.

Sistemas recomendados:

- progresso incremental para crafting;
- fragmentos acumuláveis;
- conversão limitada de materiais;
- pesquisa que avança com repetição;
- reputação por atividade;
- pity system discreto para certos conteúdos;
- objetivos paralelos;
- bônus por variar operações;
- recompensas garantidas mínimas.

A experiência deve ter sorte, mas não deve depender exclusivamente de sorte.

## 10.5 Grind Direcionado

O jogador deve poder escolher onde grindar com intenção.

Exemplos:

- uma região tem maior chance de catalisadores minerais;
- uma ruína tem fragmentos de ET ligados a contenção;
- um tipo de Breach favorece runas de estabilidade;
- uma simulação dá experiência de proficiência;
- uma Frente de Colapso gera chase loot específico;
- uma temporada aumenta chance de determinado padrão raro.

A pergunta do jogador deve ser:

> “Qual atividade me aproxima da build que quero criar?”

Não apenas:

> “Onde eu ganho mais recurso por minuto?”

---

# 11. Loop de Buildcraft

Buildcraft é o motor de identidade do jogador.

O loop de buildcraft é:

1. obter nova peça, recurso, runa, matriz, fragmento ou conhecimento;
2. identificar possível sinergia;
3. modificar uma ET ou loadout;
4. testar em operação controlada;
5. observar pontos fortes e fracos;
6. ajustar catalisador, instrumento, equipe ou estratégia;
7. validar em operação difícil;
8. refinar ou buscar peça específica;
9. consolidar estilo próprio.

Esse loop deve gerar o sentimento:

> “Essa build é minha.”

## 11.1 Camadas de Build

A build deve emergir da combinação de múltiplas camadas:

1. **Agente ou personagem ativo**  
   Define inclinação, função, limitações e identidade operacional.

2. **Equipe ou companheiros**  
   Define suporte, cobertura, interações táticas e compensação de fraquezas.

3. **Biblioteca de ETs equipadas**  
   Define ações principais disponíveis em campo.

4. **Modificadores de ET**  
   Alteram área, duração, precisão, custo, risco, propagação, reversibilidade e função.

5. **Catalisadores**  
   Afetam eficiência, estabilidade, custo e comportamento situacional.

6. **Instrumentos alquímicos**  
   Ajustam precisão, leitura, execução, coleta, análise ou risco.

7. **Conhecimento de Codex**  
   Libera leituras, vantagens, hipóteses, interações e especializações.

8. **Especializações e proficiência**  
   Consolidam estilo de jogo sem abolir incerteza.

## 11.2 Build Como Consequência do Esforço

A build deve refletir:

- grind;
- conhecimento;
- escolhas de campanha;
- loot raro;
- testes;
- falhas;
...
Dois jogadores com os mesmos personagens podem terminar com experiências muito diferentes se escolherem ETs, runas, catalisadores, instrumentos e especializações diferentes.

---

# 12. Loop de Codex

O Codex Veritatis deve ser um sistema de progressão, não apenas uma enciclopédia.

O loop de Codex é:

1. observar fenômeno;
2. coletar evidência;
3. registrar entrada parcial;
4. comparar com teoria existente;
5. desbloquear hipótese;
6. aplicar conhecimento em campo;
7. encontrar contradição;
8. recontextualizar entrada;
9. liberar nova leitura, operação, diálogo ou crafting.

## 12.1 Funções Sistêmicas do Codex

O Codex pode desbloquear:

- leitura de risco;
- identificação de fenômenos;
- vantagens contra criaturas ou Breaches;
- opções de diálogo;
- novas hipóteses narrativas;
- missões ocultas;
- receitas de crafting;
- modificadores de ET;
- entradas regionais;
- reconstrução de eventos;
- acesso a arquivos institucionais;
- interpretação pós-revelação.

## 12.2 Camadas de Conhecimento

Entradas do Codex devem poder existir em camadas:

1. **Registro Inicial** — o jogador viu algo, mas ainda não entende.
2. **Descrição Operacional** — o jogador sabe como responder em campo.
3. **Interpretação Acadêmica** — a Academia oferece explicação oficial.
4. **Contradição de Campo** — evidências não batem com a teoria.
5. **Hipótese Restrita** — o jogo permite inferências mais profundas.
6. **Recontextualização** — após marcos narrativos, a entrada muda de significado.

Essa estrutura conecta gameplay e narrativa memorável.

## 12.3 Conhecimento Como Loot

Conhecimento deve ser tratado como recompensa.

Uma operação pode ser valiosa mesmo sem item raro se conceder:

- nova entrada;
- nova hipótese;
- nova fraqueza identificada;
- novo padrão de Breach;
- nova leitura de terreno;
- nova relação entre conceitos;
- nova opção de crafting.

---

# 13. Loop de Progressão Regional

Regiões não devem ser apenas mapas.

Cada região deve funcionar como um ecossistema de operações, risco, reputação, recursos, eventos e consequências.

O loop regional é:

1. desbloquear região;
2. realizar operações iniciais;
3. entender ameaças locais;
4. estabilizar ou agravar pontos críticos;
5. desbloquear missões regionais;
6. alterar estado da região;
7. abrir atividades repetíveis específicas;
8. enfrentar marco regional;
9. retornar mais tarde com novo conhecimento ou build;
10. recontextualizar a região após revelações.

## 13.1 Estado das Regiões

Regiões podem ter estados como:
...
- militarizada;
- reconstruindo;
- politicamente hostil;
- academicamente disputada;
- em surto de Breach;
- em Frente de Colapso;
- sob evento sazonal.

Estados regionais devem afetar:
...
- custo de entrada;
- tipo de loot;
- chance de incidentes;
- resposta institucional.

## 13.2 Progressão Regional Sem Mundo Aberto

AZOTH: BREACH não precisa de mundo aberto para parecer vivo.

A sensação de mundo vivo deve vir de:

- regiões que mudam;
- retorno a áreas;
- novas operações após marcos;
- Codex que recontextualiza locais;
- eventos emergentes;
- consequências persistentes;
- loot regional;
- estados de risco visíveis.

---

# 14. Loop de Progressão Institucional

Academias e instituições devem funcionar como eixos de acesso, confiança, conflito e especialização.

O loop institucional é:

1. cumprir operações ligadas a uma instituição;
2. ganhar confiança ou reputação;
3. receber acesso a arquivos, permissões e recursos;
4. encontrar conflitos de interesse;
5. escolher alinhamentos práticos;
6. desbloquear ETs, equipamentos ou missões;
7. sofrer consequências políticas ou operacionais;
8. avançar para decisões de maior impacto.

## 14.1 Autoridade Institucional

Autoridade Institucional pode liberar:
...
- diálogo com figuras relevantes.

Autoridade não é “nível social genérico”. Ela representa confiança operacional e acesso formal.

## 14.2 Conflito Institucional

Instituições não devem ser apenas lojas de upgrades.
...
- limites éticos;
- disputas sobre informação.

Progressão institucional deve gerar oportunidade e tensão.

---

# 15. Loop de Progressão de Personagem e Equipe

Personagens jogáveis e companheiros devem progredir sem transformar o jogo em coleção infinita de unidades.

O loop de personagem/equipe é:

1. recrutar ou desbloquear personagem;
2. entender função tática e narrativa;
3. usar em operações;
4. desenvolver proficiência e afinidade operacional;
5. desbloquear opções de especialização;
6. integrar com ETs e build;
7. revelar camada narrativa do personagem;
8. consolidar papel na equipe.

## 15.1 Progressão de Personagem

Progressão de personagem pode incluir:

- proficiência em certos tipos de ET;
- talentos operacionais;
- especializações táticas;
- vínculos narrativos;
- reações a decisões;
- habilidades de suporte;
- vantagens em tipos de operação;
- desbloqueios de diálogo;
- relação com Academias ou regiões.

## 15.2 Equipe Pequena, Profunda e Memorável

A recomendação estrutural permanece:
...
A equipe deve sustentar o gameplay, não virar gacha.

---

# 16. Loop de Progressão Alquímica

Progressão alquímica deve ser a principal forma de crescimento sistêmico.

O loop alquímico é:

1. aprender ou obter ET;
2. usar em campo;
3. observar limitações;
4. obter recursos ou conhecimento;
5. modificar ET;
6. testar variação;
7. melhorar proficiência;
8. desbloquear complexidade adicional;
9. integrar ET a uma build;
10. aplicar em operações mais difíceis.

## 16.1 Proficiência Alquímica

Proficiência representa capacidade prática de executar com maior precisão e menor desperdício.

Em gameplay, pode afetar:

- chance de falha prática;
- estabilidade;
- custo;
- eficiência;
- leitura de risco;
...
Proficiência não elimina a Incerteza Fundamental da Transmutação.

## 16.2 Complexidade Alquímica

Complexidade representa a capacidade de conceber e executar ETs mais sofisticadas.

Em gameplay, pode afetar:

- número de camadas de uma ET;
- tipos de modificadores aceitos;
- geometrias mais avançadas;
- combinação de efeitos;
- uso de catalisadores raros;
- acesso a técnicas especializadas.

Complexidade não significa controle absoluto.

## 16.3 Precisão Alquímica

Precisão deve funcionar como a medida operacional de qualidade da especificação e execução.
...
Precisão alta torna o jogador mais confiável, não infalível.

---

# 17. Estrutura de Desbloqueios

Desbloqueios devem acontecer em múltiplas cadências.

## 17.1 Desbloqueios Imediatos

Após operações curtas:

- materiais;
- amostras;
- pequenos avanços de proficiência;
- loot comum/incomum;
- fragmentos;
- progresso em objetivos;
- pequenas entradas de Codex.

## 17.2 Desbloqueios de Médio Prazo

Após um conjunto de operações:
...
- nova área regional;
- nova entrada importante de Codex;
- nova função de crafting;
- melhoria de equipamento.

## 17.3 Desbloqueios de Marco

Após missões principais, arcos regionais ou eventos narrativos:

- nova região;
- mudança de estado do mundo;
- nova camada de Codex;
- acesso institucional maior;
- nova categoria de risco;
- novo sistema de gameplay;
- nova Frente de Colapso;
- recontextualização narrativa.

## 17.4 Desbloqueios de Endgame

No endgame:

- Frentes de Colapso avançadas;
- Protocolos Perdidos;
- Runas Irregulares;
...
- builds extremas, mas não canonicamente impossíveis.

---

# 18. Ritmo de Campanha

A campanha deve alternar entre tensão, descoberta, preparação e recompensa.

Uma estrutura recomendada de ritmo é:

1. **Introdução Operacional**  
   O jogador aprende operações, ETs básicas, risco e Codex inicial.

2. **Abertura Regional**  
   O jogador acessa região inicial, incidentes e primeiras escolhas.

3. **Expansão de Sistemas**  
   Novas ETs, crafting básico, reputação institucional e missões repetíveis.

4. **Primeira Recontextualização**  
   O jogador percebe que explicações oficiais são incompletas.

5. **Abertura de Múltiplas Regiões**  
   Escolha de prioridades, grind direcionado, progressão regional.

6. **Complexidade de Build**  
   Engenharia de ETs mais profunda, modificadores raros e sinergias.

7. **Conflito Institucional**  
   Escolhas políticas, acesso restrito, consequências.

8. **Revelações Maiores**  
   Codex muda de função, termos anteriores ganham novo significado.

9. **Transição ao Endgame**  
   Frentes de Colapso e regimes pós-revelação são introduzidos.

10. **Continuidade Pós-Campanha**  
   Temporadas, chase loot, operações avançadas e reinterpretação do mundo.

---

# 19. Relação Entre Campanha e Grind

Campanha e grind devem se reforçar.

## 19.1 Campanha Dá Significado ao Grind

A campanha explica por que certas atividades existem:

- por que Breaches se repetem;
- por que regiões instáveis importam;
- por que Academias precisam de dados;
- por que materiais raros são valiosos;
- por que ruínas reagem a certos eventos;
- por que conhecimento muda o acesso a operações.

## 19.2 Grind Dá Força à Campanha

O grind permite que o jogador:

- melhore build antes de missões difíceis;
- busque recursos específicos;
- teste ETs;
- conheça regiões;
- desbloqueie Codex adicional;
- sinta domínio mecânico;
- enfrente campanha com identidade própria.

## 19.3 Nenhum Dos Dois Deve Invalidar o Outro

A campanha não deve exigir grind excessivo.

O grind não deve trivializar a campanha.

A relação correta é:

> **A campanha pode ser concluída com bom entendimento e preparo razoável; o grind permite profundidade, otimização, personalização e domínio.**

---

# 20. Endgame: Loop de Frentes de Colapso

O endgame deve transformar o conhecimento acumulado em risco contínuo.

O loop de Frente de Colapso é:

1. selecionar Frente de Colapso;
2. escolher nível de risco ou profundidade;
3. preparar build e recursos;
4. entrar em sequência de operações ou confrontos;
5. acumular instabilidade;
6. obter recompensas crescentes;
7. decidir extrair ou continuar;
8. enfrentar evento crítico;
9. consolidar recompensas;
10. refinar build para próxima incursão.

## 20.1 Push Your Luck

Frentes de Colapso devem ter uma lógica de risco crescente.

O jogador deve sentir:

> “Eu já consegui algo bom. Continuar pode me dar algo incrível, mas posso perder parte do que ganhei.”

Essa tensão é essencial para endgame.

## 20.2 Chase Loot Ultrarraro

O endgame deve conter loot ultrarraro capaz de gerar obsessão saudável.
...
- Artefatos de Convergência;
- Padrões Ômega de ET;
- variantes visuais raríssimas;
- registros de Codex raros;
- matrizes de alta complexidade.

Chase loot deve mudar estilo de jogo, abrir possibilidades ou criar identidade, mas não deve abolir risco.

## 20.3 Endgame Não é Fim da Verdade

O endgame não representa domínio completo do universo.

Ele representa:

- atuação em regime pós-revelação;
- risco maior;
- conhecimento mais pesado;
- responsabilidade ampliada;
- continuidade da instabilidade;
- exploração de consequências.

---

# 21. Temporadas e Live Ops

Temporadas devem ser eventos diegéticos dentro do mundo.

Elas não devem parecer conteúdo externo sem relação com AZOTH.

## 21.1 Estrutura de Temporada

Uma temporada pode incluir:

- fenômeno temporário;
- alteração em regiões;
- linha narrativa curta;
- incidentes especiais;
- modificadores sazonais;
- loot exclusivo;
- padrões visuais;
- desafios de Frente de Colapso;
- entradas temporárias ou permanentes de Codex;
- ranking opcional ou metas comunitárias, caso multiplayer exista.

## 21.2 Exemplos de Temporadas

Exemplos coerentes:

- **Maré de Ruído** — aumento de Ruído Informacional em regiões específicas.
- **Arquivos Lacrados** — foco em investigação e documentos restritos.
- **Fendas de Umbra** — maior risco em Breaches escuras, loot instável.
- **Ecos de Ruína** — ruínas antigas reagem a eventos recentes.
- **Surto de Cristalização** — operações focadas em contenção material.

## 21.3 Relação Com Progressão

Temporadas devem oferecer:

- recompensas desejáveis;
- variação de meta;
- novos motivos para testar builds;
- retorno ao jogo;
- narrativa complementar;
- oportunidades para jogadores novos e avançados.

Elas não devem exigir que o jogador abandone a campanha principal.

---

# 22. Tipos de Progressão

A progressão de AZOTH: BREACH deve ser distribuída para evitar dependência de um único número.

## 22.1 Progressão Horizontal

Desbloqueia novas opções.

Deve ser o tipo dominante.
...
- nova leitura de Codex;
- nova estratégia de contenção;
- novo tipo de operação.

## 22.2 Progressão Condicional

Cria força situacional.

Exemplos:

- bônus contra tipo específico de Breach;
- melhor coleta em região específica;
- eficiência em operações noturnas;
- estabilidade contra certos efeitos;
- sinergia com determinado catalisador.

## 22.3 Progressão Vertical Controlada

Aumenta números com teto.

Exemplos:

- pequena redução de custo;
- pequena melhora de precisão;
- pequena chance adicional de extração;
- leve aumento de duração;
- pequena reserva extra.

Progressão vertical deve existir para sensação contínua de melhora, mas não pode ser o coração do jogo.

## 22.4 Progressão Narrativa

Altera entendimento e acesso.

Exemplos:

- novas interpretações;
- recontextualização de eventos;
- personagens revelam informações;
- Academias liberam arquivos;
- regiões mudam de estado;
- Codex ganha novas camadas.

## 22.5 Progressão Estética
...
- emblemas institucionais;
- marcas de operação;
- registros visuais de conquistas.

Progressão estética é muito importante para retenção e identidade, especialmente quando conectada a raridade e mérito.

---

# 23. Estados de Disponibilidade de Atividades

O jogador deve sempre ter algo útil para fazer.

Atividades devem existir em diferentes estados:

## 23.1 Sempre Disponível

- operações básicas de grind;
- simulações acadêmicas;
- coleta comum;
- incidentes menores;
- testes de build;
...
- eventos ligados ao estado da região.

## 23.3 Disponível por Campanha
...
## 23.5 Disponível por Endgame

- Frentes de Colapso;
- chase loot;
- riscos avançados;
- atividades de alta profundidade;
- variações sazonais extremas.

---

# 24. Ritmo de Recompensa

O jogo deve equilibrar quatro ritmos de recompensa.

## 24.1 Recompensa Imediata
...
## 24.3 Recompensa Surpresa

A qualquer momento:

- loot raro;
- fragmento inesperado;
- evento especial;
- descoberta de Codex;
- operação oculta;
- padrão visual raro.

## 24.4 Recompensa Aspiracional

Após muito esforço:

- chase loot;
- build avançada;
- domínio de Frente de Colapso;
- artefato raro;
- protocolo perdido;
- reconhecimento institucional;
- conquista sazonal.

A combinação desses ritmos sustenta retenção.

---

# 25. Falha, Risco e Continuidade

Falha deve fazer parte do loop.

AZOTH: BREACH deve evitar tanto punição irrelevante quanto punição destrutiva demais.
...
- região agravada;
- recurso consumido;
- personagem ferido ou indisponível temporariamente;
- Codex incompleto;
- Breach parcialmente contida;
- retirada forçada.
...
- conhecimento;
- dados de risco;
- entrada parcial de Codex;
- pista alternativa;
- amostra instável;
- nova operação corretiva;
- alerta regional;
- consequência narrativa.

A falha deve ser memorável, não apenas frustrante.

## 25.3 Risco Como Escolha

Sempre que possível, o jogador deve optar por risco maior em troca de recompensa maior.

Exemplos:

- continuar em zona instável;
- tentar extração adicional;
- usar ET experimental;
- preservar amostra perigosa;
- enfrentar inimigo opcional;
- abrir câmara lacrada;
- aprofundar Frente de Colapso.

---

# 26. Jornada de Progressão do Jogador

A jornada de progressão ideal pode ser descrita em fases.

## 26.1 Fase 1 — Aprendiz Operacional
...
> “Estou aprendendo a sobreviver em campo.”

## 26.2 Fase 2 — Agente de Campo

O jogador começa a:

- escolher operações;
- grindar materiais;
- modificar ETs simples;
- lidar com estados regionais;
- entender reputação;
- observar padrões de Breach.

Sentimento desejado:

> “Tenho opções e consigo me preparar melhor.”

## 26.3 Fase 3 — Especialista em Construção de Build
...
> “Minha build está tomando forma.”

## 26.4 Fase 4 — Operador de Alto Risco
...
> “Meu conhecimento tem peso e minhas escolhas importam.”

## 26.5 Fase 5 — Especialista Pós-Revelação

O jogador entra no regime de endgame.
...
> “Eu entendo os sistemas o bastante para desafiar riscos maiores, mas ainda não controlo tudo.”

---

# 27. Relação com Documentos Posteriores

Este documento define estrutura. Os documentos seguintes devem detalhar sistemas específicos.

## 27.1 Relação com `04.2`

`04.2 — Transmutação Como Sistema de Jogo` deve detalhar:

- execução jogável de ETs;
- custo;
- falha;
- risco;
- precisão;
...
- geometria;
- catalisadores;
- abstração da Máquina de Execução.

## 27.2 Relação com `04.3`

`04.3 — Combate, Funções Táticas e Resolução` deve detalhar:
...
- inimigos;
- resolução tática;
- interação com Breach e terreno.

## 27.3 Relação com `04.4`

`04.4 — Exploração, Mundo Jogável e Estruturas de Campo` deve detalhar:
...
- operações fora de combate.

## 27.4 Relação com `04.5`

`04.5 — Progressão do Jogador, Builds e Especialização` deve detalhar:
...
## 27.5 Relação com `04.6`

`04.6 — Recursos, Crafting, Pesquisa e Economia de Sistemas` deve detalhar:
...
## 27.6 Relação com `04.8`

`04.8 — Interface, UX e Legibilidade de Gameplay` deve detalhar:
...
## 27.7 Relação com `04.10`

`04.10 — Balanceamento, Telemetria e Critérios de Validação` deve detalhar:

- métricas de retenção;
- cadência de recompensa;
...
# 28. Decisões Consolidadas Neste Documento

Este documento consolida as seguintes decisões:

1. A unidade principal de gameplay é a **operação**.
2. O core loop é **Observar → Escolher → Preparar → Operar → Coletar → Interpretar → Refinar → Recomeçar**.
3. O jogo deve sustentar sessões curtas de 5 a 15 minutos.
4. Toda operação deve gerar algum progresso, mesmo sem loot raro.
5. O grind permanente é obrigatório.
6. O Quadro de Incidentes é o principal sistema de grind durante a campanha.
7. Campanha, grind e endgame compartilham a mesma base sistêmica.
8. Codex Veritatis é progressão jogável, não apenas lore.
9. Buildcraft deve ser uma camada central de retenção.
10. O jogador deve construir builds únicas por esforço, conhecimento, loot e teste.
11. Regiões devem possuir estados persistentes.
12. Autoridade Institucional deve funcionar como eixo de acesso e tensão.
13. Frentes de Colapso estruturam o endgame.
14. O endgame deve conter chase loot ultrarraro.
15. Temporadas devem ser eventos diegéticos, não apenas conteúdo externo.
16. Progressão deve priorizar poder horizontal e condicional.
17. Poder vertical deve existir, mas com teto.
18. Falha deve poder gerar conhecimento e continuidade.
19. A campanha não deve exigir grind excessivo.
20. O grind não deve trivializar a campanha.

---

# 29. Decisões Ainda Não Fechadas
...
- número final de personagens;
- número de ETs por loadout;
- quantidade de slots de modificadores;
- duração exata de temporadas;
- custos finais de crafting;
- fórmulas de proficiência;
...
Essas decisões devem ser tomadas nos documentos próprios.

---

# 30. Riscos de Design

## 30.1 Risco: Grind Virar Obrigação

Se a campanha exigir farm excessivo, o jogador pode sentir bloqueio artificial.

Mitigação:

- campanha balanceada para preparo razoável;
- grind como otimização e personalização;
- recompensas paralelas;
- missões narrativas com alternativas táticas.

## 30.2 Risco: Loot Virar Mais Importante que Alquimia

Se loot for apenas número maior, o sistema perde identidade.

Mitigação:

- loot deve modificar ETs, risco, leitura, estilo e função;
- conhecimento deve ser recompensa;
- raridade deve estar conectada a lore e operação.

## 30.3 Risco: Progressão Quebrar Cânone

Se o jogador ficar poderoso demais, o universo perde coerência.
...
- limitar poder vertical;
- manter risco;
- respeitar Incerteza Fundamental;
- impedir controle absoluto.

## 30.4 Risco: Excesso de Sistemas

Muitos loops simultâneos podem confundir.
...
- operações simples no início;
- complexidade crescente.

## 30.5 Risco: Codex Ser Ignorado

Se Codex não afetar gameplay, vira texto opcional sem força.

Mitigação:

- Codex deve liberar leituras, vantagens, crafting, missões e diálogos;
- entradas devem ter utilidade operacional;
- recontextualização deve alterar percepção do jogador.

---

# 31. Direção Final

A estrutura de progressão de AZOTH: BREACH deve fazer o jogador voltar por três motivos simultâneos:

1. **Quero saber o que está acontecendo.**  
   Campanha, Codex, personagens e revelações.

2. **Quero ficar mais capaz.**  
   ETs, proficiência, builds, crafting, equipe e conhecimento.

3. **Quero tentar mais uma vez.**  
   Grind, loot raro, Frentes de Colapso, temporadas e risco recompensador.

O jogo deve funcionar porque esses três impulsos se alimentam.

A campanha dá significado ao grind.  
O grind fortalece a build.  
A build permite enfrentar operações mais difíceis.  
Operações difíceis revelam conhecimento.  
Conhecimento muda a forma como o jogador entende campanha, mundo e sistemas.  
Esse entendimento gera novas metas, novas builds e novas razões para continuar.

---

# 32. Princípio de Encerramento

O jogador de AZOTH: BREACH deve sentir que cada sessão deixou alguma marca.

Pode ser uma marca pequena:

- um material;
- um fragmento;
- uma entrada de Codex;
- um teste de build;
- uma reputação alterada;
- uma região um pouco mais estável;
- uma hipótese nova.

Pode ser uma marca grande:

- uma revelação;
- uma ET transformada;
- uma build validada;
- uma Frente vencida;
- um chase loot obtido;
- uma região recontextualizada.

Mas nunca deve ser nada.

A regra final deste documento é:

> **Em AZOTH: BREACH, toda operação deve transformar algo: o mundo, o jogador, a build, o Codex, a região, a relação institucional ou a compreensão do universo.**
<!-- FIM: docs/04_gameplay/AZOTH_04.1_Core_Loop_e_Estrutura_de_Progressao_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.2_Transmutacao_Como_Sistema_de_Jogo_v0.1.md -->
...
Este documento não define o balanceamento final de dano, custo, cooldown, alcance, porcentagens, drop rates, número de slots ou interface final. Esses temas serão detalhados nos documentos `04.3`, `04.5`, `04.6`, `04.8` e `04.10`.
...
<!-- FIM: docs/04_gameplay/AZOTH_04.2_Transmutacao_Como_Sistema_de_Jogo_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.3_Combate_Funcoes_Taticas_e_Resolucao_v0.1.md -->
...
Este documento não define valores finais de dano, fórmulas numéricas, listas completas de inimigos, animações, UI final, drop rates, duração de temporadas ou balanceamento final. Esses temas serão refinados em `04.6`, `04.8` e `04.10`.
...
<!-- FIM: docs/04_gameplay/AZOTH_04.3_Combate_Funcoes_Taticas_e_Resolucao_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.4_Exploracao_Mundo_Jogavel_e_Estruturas_de_Campo_v0.1.md -->
...
<!-- FIM: docs/04_gameplay/AZOTH_04.4_Exploracao_Mundo_Jogavel_e_Estruturas_de_Campo_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.5_Progressao_do_Jogador_Builds_e_Especializacao_v0.1.md -->
# AZOTH: BREACH — Documento 04.5 — Progressão do Jogador, Builds e Especialização

## Documento de Crescimento Operacional, Identidade Mecânica e Buildcraft

**Série:** 04 — Gameplay  
**Código:** AZOTH_04.5  
**Título:** Progressão do Jogador, Builds e Especialização  
**Versão:** v0.1  
**Status:** Documento inicial consolidado  
**Documento anterior:** `AZOTH_04.4_Exploracao_Mundo_Jogavel_e_Estruturas_de_Campo_v0.1.md`  
**Função:** Definir como o jogador cresce, especializa seus agentes, constrói builds, amplia capacidade operacional, transforma conhecimento em poder jogável e sente que sua força resulta de esforço, domínio sistêmico, experimentação, grind, escolhas narrativas e decisões de progressão.

---

# 1. Função deste Documento

Este documento define a progressão do jogador em **AZOTH: BREACH**.

Ele aprofunda a visão estabelecida em `04.0 — Arquitetura do Gameplay`, os loops definidos em `04.1 — Core Loop e Estrutura de Progressão`, a transmutação jogável definida em `04.2 — Transmutação Como Sistema de Jogo`, o combate definido em `04.3 — Combate, Funções Táticas e Resolução` e a exploração definida em `04.4 — Exploração, Mundo Jogável e Estruturas de Campo`.

Este documento responde às seguintes perguntas:

- como o jogador se torna mais forte sem romper o cânone;
- o que significa progredir em AZOTH: BREACH;
- como personagens, equipe, ETs, equipamentos, Codex, reputação e especializações interagem;
- como o jogador constrói uma build própria;
- como grind, loot, conhecimento e teste de builds viram progressão percebida;
- como evitar que progressão vire apenas aumento de números;
- como criar diferentes estilos de jogo sem gerar classes rígidas demais;
- como o jogo recompensa esforço sem trivializar campanha, risco ou narrativa;
- como endgame e temporadas sustentam progressão de longo prazo;
- quais limites canônicos devem guiar toda evolução mecânica.

Este documento não define drop rates, custo exato de upgrades, árvores finais de talentos, número final de níveis, fórmulas matemáticas, interface de inventário, economia final de materiais ou balanceamento numérico. Esses temas serão detalhados principalmente em `04.6 — Recursos, Crafting, Pesquisa e Economia de Sistemas`, `04.8 — Interface, UX e Legibilidade de Gameplay` e `04.10 — Balanceamento, Telemetria e Critérios de Validação`.

A função do `04.5` é estabelecer a gramática de progressão e buildcraft.

---

# 2. Precedência Canônica

Toda progressão em AZOTH: BREACH deve respeitar a hierarquia documental do projeto:
...
Portanto, progressão não pode:

- transformar o jogador em entidade acima das Leis Fundamentais;
- permitir que poder substitua conhecimento validado;
- permitir transmutação sem ET válida;
- permitir que proficiência elimine custo, risco, matéria, energia, instabilidade ou limite de informação;
- liberar domínio de Camadas de revelação antes do marco narrativo correspondente;
- transformar Azoth em mana genérica acumulável;
- tratar raridade como autorização para violar cânone;
- permitir que loot ultrarraro revele a Verdade estrutural cedo demais;
- permitir crescimento infinito de números que torne Breach irrelevante;
- converter Codex em árvore mágica de poderes desconectados de evidência;
- criar especializações que contradigam a MAA, a LET, a Gramática Geométrica ou a narrativa estabelecida.

O jogador pode ampliar capacidade operacional, leitura de risco, qualidade de execução, repertório de ETs, precisão, opções táticas, eficiência, resiliência e profundidade de build.

O jogador não pode escapar da estrutura cosmológica do universo.

---

# 3. Princípio Central da Progressão

O princípio central deste documento é:

> **Progredir em AZOTH: BREACH significa transformar esforço, conhecimento e experimentação em maior capacidade operacional, sem abolir custo, risco, consequência ou limite de revelação.**

A fantasia correta é:

> **“Eu fiquei mais forte porque investiguei melhor, farmei recursos, compreendi sistemas, refinei minhas ETs, testei sinergias, enfrentei missões difíceis e construí uma solução própria.”**

A fantasia incorreta é:

> “Eu fiquei forte porque meu nível subiu e agora ignoro as regras do mundo.”

Progressão deve produzir três sentimentos simultâneos:

1. **Domínio:** o jogador entende melhor o sistema.
2. **Autoria:** o jogador sente que sua build é resultado de escolhas próprias.
3. **Recompensa:** o jogador percebe que esforço, grind e risco geraram ganho real.

AZOTH: BREACH deve evitar progressão passiva demais. O jogador não deve apenas receber poder. Ele deve **construir poder**.

---

# 4. Definição de Progressão em AZOTH: BREACH

Progressão é a soma de oito eixos:

1. **Progressão do Agente**
2. **Progressão da Equipe**
3. **Progressão Alquímica**
4. **Progressão de ETs**
5. **Progressão de Instrumentos e Equipamentos**
6. **Progressão de Codex e Pesquisa**
7. **Progressão Regional e Institucional**
8. **Progressão de Endgame e Temporadas**

Nenhum eixo deve carregar sozinho toda a sensação de crescimento.

O jogador deve sentir progresso mesmo quando não ganha um item raro. Exemplos:

- desbloqueou uma nova opção de relatório;
- reduziu risco de uma categoria de Breach;
- completou uma entrada do Codex;
- aumentou proficiência em um Domínio;
- abriu uma rota regional;
- refinou uma ET;
- conseguiu material para um upgrade futuro;
- descobriu uma sinergia de build;
- estabilizou uma região;
- obteve acesso a operações mais difíceis;
- desbloqueou variação visual de círculo;
- melhorou chance de extração em ruínas específicas.

A progressão ideal é composta, não linear.

---

# 5. Progressão Não é Apenas Poder Vertical

AZOTH: BREACH deve usar três tipos de poder:

## 5.1 Poder Horizontal

Poder horizontal amplia opções.
...
- nova interação de Codex;
- nova rota de exploração;
- novo companheiro;
- nova forma de resolver objetivo.

Este deve ser o tipo dominante de progressão.

## 5.2 Poder Condicional

Poder condicional é forte em contextos específicos.

Exemplos:

- melhor desempenho em Breaches térmicas;
- redução de Ruído em ruínas cristalinas;
- bônus contra organismos deslocados;
- maior coleta em zonas de alta instabilidade;
- maior precisão em ETs de estabilização;
- aumento de defesa quando há civis no campo;
- maior chance de fragmentos em operações longas.

Este tipo cria buildcraft saudável, porque incentiva especialização e troca de loadout.

## 5.3 Poder Vertical Controlado

Poder vertical melhora números.

Exemplos:

- mais vida;
- mais energia operacional;
- mais precisão;
- menor custo;
- maior duração;
- menor chance de falha;
- mais dano técnico;
- melhor resistência a estados.

Ele deve existir, porque recompensa direta é importante. Porém, deve ter tetos, curvas suaves e trade-offs.

O jogo não deve permitir progressão vertical infinita que trivialize campanha, Breach, inimigos ou decisões táticas.

---

# 6. Camadas de Build

A build do jogador é composta por camadas empilhadas.

Cada camada deve ser compreensível sozinha, mas gerar profundidade quando combinada.

As camadas oficiais de build são:

1. **Agente Principal**
2. **Companheiros de Campo**
3. **Função Tática da Equipe**
4. **Biblioteca de ETs**
5. **ETs Equipadas**
6. **Modificadores de ET**
7. **Runas**
8. **Geometrias**
9. **Catalisadores**
10. **Instrumentos Alquímicos**
11. **Protocolos de Campo**
12. **Especializações**
13. **Pesquisa e Codex**
14. **Vínculos Institucionais**
15. **Artefatos e Chase Loot**

Uma build não deve ser definida por um único item.

O objetivo é que dois jogadores possam usar a mesma ET base e ainda assim ter experiências diferentes por causa de:

- modificadores diferentes;
- função de equipe diferente;
- catalisadores diferentes;
- instrumentos diferentes;
- conhecimento de Codex diferente;
- especialização diferente;
- tolerância de risco diferente;
- prioridade de missão diferente;
- relação institucional diferente.

---

# 7. Progressão do Agente Principal

O agente principal representa o eixo de identidade do jogador.

Ele não deve ser um avatar onipotente nem uma folha em branco absoluta. Ele deve ter papel narrativo, inserção institucional e capacidade de especialização.

## 7.1 Funções da Progressão do Agente

A progressão do agente deve:

- dar senso de crescimento contínuo;
- desbloquear opções de build;
- permitir especializações de campo;
- refletir experiência acumulada;
- sustentar a fantasia de alquimista operacional;
- preservar vulnerabilidade diante de Breach;
- conectar mecânica e narrativa.

## 7.2 Atributos Recomendados

Atributos finais serão definidos em balanceamento, mas o modelo conceitual deve partir de atributos como:

- **Precisão Alquímica:** qualidade de execução e redução de variação.
- **Controle Operacional:** capacidade de manter estabilidade sob pressão.
- **Leitura de Campo:** identificação de risco, oportunidade e evidência.
- **Resiliência:** resistência a dano, estados e pressão.
- **Foco:** recurso mental/operacional para ETs complexas.
- **Técnica:** eficiência no uso de instrumentos e protocolos.
- **Adaptação:** capacidade de responder a eventos imprevistos.

Esses atributos não devem substituir Proficiência Alquímica, Complexidade Alquímica ou Precisão Alquímica como conceitos canônicos. Eles são traduções de gameplay.

## 7.3 Crescimento do Agente

O agente pode crescer por:

- experiência de operações;
- marcos narrativos;
- treinamento acadêmico;
- pesquisa aplicada;
- uso recorrente de Domínios;
- conclusão de operações difíceis;
- superação de Frentes de Colapso;
- escolhas de especialização;
- relação com companheiros;
- exposição controlada a fenômenos.

Progressão do agente não deve ser apenas XP por combate.

Operações sem combate também precisam contribuir para crescimento.

---

# 8. Progressão da Equipe

AZOTH: BREACH deve favorecer uma equipe pequena, profunda e memorável.

A equipe permite que o jogador personalize estratégia sem exigir dezenas de personagens.

## 8.1 Função da Equipe

A equipe existe para:

- criar sinergias táticas;
- representar perspectivas narrativas;
- modular risco;
- ampliar repertório de ETs;
- criar decisões pré-operação;
- gerar vínculos emocionais;
- permitir builds diferentes com os mesmos recursos.

## 8.2 Progressão de Companheiros

Companheiros podem evoluir por:
...
- proficiência em Domínios;
- eventos de confiança;
- exposição a tipos específicos de campo;
- desbloqueios de Codex.

Cada companheiro deve ter:

- função tática clara;
- conflito narrativo ou visão de mundo;
- forma própria de interagir com Breach;
- utilidade fora de combate;
- opções de especialização.

## 8.3 Funções Táticas de Equipe

As funções táticas básicas são:
...
Um personagem pode cobrir mais de uma função, mas não deve cobrir todas.

A composição da equipe deve ser uma decisão real.

## 8.4 Sinergias de Equipe

Sinergias devem surgir de combinações como:

- ET de um agente prepara alvo para outro;
- companheiro reduz risco de uma técnica;
- um agente revela vulnerabilidade e outro explora;
- um personagem estabiliza campo para permitir ET complexa;
- um suporte aumenta extração de material raro;
- um investigador abre opção de objetivo alternativo;
- um especialista reduz consequência de falha.

Sinergias devem incentivar experimentação, não exigir combinações obrigatórias.

---

# 9. Progressão Alquímica

Progressão alquímica é o coração técnico do crescimento.

Ela deve ser separada da progressão genérica do personagem.

## 9.1 Proficiência Alquímica

Proficiência Alquímica representa familiaridade prática com execução.

Em gameplay, ela pode afetar:
...
- menor Ruído gerado;
- melhor extração;
- desbloqueio de versões refinadas;
- leitura mais clara de risco.

Proficiência não elimina custo, não garante sucesso absoluto e não permite executar ET sem condição válida.

## 9.2 Complexidade Alquímica

Complexidade Alquímica representa capacidade de lidar com ETs e estruturas mais sofisticadas.

Em gameplay, ela pode afetar:

- quantidade de modificadores suportados;
- acesso a ETs mais avançadas;
- compatibilidade com geometrias complexas;
- possibilidade de usar protocolos experimentais;
- leitura de efeitos colaterais;
- uso de catalisadores instáveis;
- resistência a sobrecarga cognitiva.

Complexidade não é poder bruto. Ela é capacidade de operar sistemas mais difíceis.

## 9.3 Precisão Alquímica

Precisão Alquímica representa qualidade de ajuste entre intenção, especificação e execução.

Em gameplay, ela pode afetar:

- confiabilidade;
- redução de efeitos colaterais;
- acerto em alvos pequenos;
- controle de área;
- estabilidade de ET modificada;
- menor risco de dano colateral;
- melhor resultado em missões com civis, ruínas frágeis ou material sensível.

Precisão deve ser especialmente importante para jogadores que preferem controle, segurança e eficiência.

## 9.4 Especialização por Domínio

O jogador pode se especializar em Domínios jogáveis derivados da documentação alquímica.
...
Cada especialização deve abrir estilo, não apenas bônus.

Exemplo:

- Matéria favorece barreiras, terreno, decomposição e reconstrução controlada.
- Energia favorece impulso, dano técnico, aquecimento, resfriamento e sobrecarga.
- Vida favorece suporte, contenção biológica, mitigação e leitura de organismos.
- Informação favorece análise, previsão, Codex, identificação e manipulação de padrões.

Nenhum Domínio deve virar escola mágica arbitrária.

---

# 10. Progressão de ETs

ETs são a unidade central da ação alquímica.

A progressão de ETs deve ser profunda, mas legível.

## 10.1 Níveis de Domínio de ET

Uma ET pode ter progressão própria por uso, refinamento e pesquisa.

Modelo conceitual:

1. **Conhecida:** o jogador possui a ET base.
2. **Validada:** a ET foi usada com sucesso em campo.
3. **Refinada:** a ET recebeu ajustes estáveis.
4. **Especializada:** a ET foi adaptada a um estilo.
5. **Integrada:** a ET interage com Codex, equipamento e build.
6. **Avançada:** a ET aceita modificadores mais complexos.
7. **Assinada:** a ET se torna parte reconhecível da identidade da build do jogador.

Esses nomes são conceituais e podem mudar.

## 10.2 Progressão por Uso

Usar uma ET deve gerar familiaridade.

Mas o jogo deve evitar que o jogador fique preso a uma única técnica só porque ela escala infinitamente.

Progressão por uso pode:

- reduzir custo mínimo;
- melhorar previsão de risco;
- liberar variações;
- aumentar compatibilidade com runas;
- reduzir instabilidade em contextos conhecidos;
- desbloquear cosméticos funcionais;
- abrir entradas de Codex relacionadas.

## 10.3 Progressão por Pesquisa

Pesquisa deve permitir avanços que uso bruto não permite.

Exemplos:

- decifrar fragmento de ET;
- comparar laudos de campo;
- completar entrada de fenômeno;
- validar hipótese em operação;
- sacrificar materiais raros para estudo;
- obter autorização institucional.

Pesquisa torna conhecimento em capacidade.

## 10.4 Progressão por Modificação

Modificar ETs é uma das principais fontes de buildcraft.

Cada modificação deve ter trade-off.

Exemplos:

- mais área, menos precisão;
- mais duração, mais custo;
- execução mais rápida, mais Ruído;
- dano maior, menor estabilidade;
- maior controle, menor alcance;
- menor risco, menor potência;
- extração melhor, menor desempenho tático.

Modificação sem custo destrói o design.

## 10.5 Assinatura de Build

Uma ET deve poder virar assinatura do jogador.

Exemplo:

Dois jogadores usam **Selagem Parcial de Fissura**:

- Jogador A cria uma versão defensiva, segura, barata e orientada a evacuação.
- Jogador B cria uma versão arriscada, ampla, agressiva e voltada a Frentes de Colapso.

A mesma ET base gera identidades diferentes.

Esse é um objetivo estrutural do sistema.

---

# 11. Especializações

Especializações são caminhos de identidade mecânica.

Elas não devem ser classes rígidas, mas trajetórias de competência.

## 11.1 Princípio das Especializações

Uma especialização deve responder:

> **“Que tipo de alquimista operacional eu estou me tornando?”**

Não deve responder apenas:

> “Qual bônus de dano eu escolhi?”

## 11.2 Categorias de Especialização

Categorias recomendadas:

### Especialista em Contenção

Foco em estabilizar Breaches, reduzir instabilidade, proteger civis, atrasar colapso e controlar risco.

### Especialista em Transmutação de Campo

Foco em terreno, barreiras, obstáculos, rotas, manipulação material e controle espacial.

### Especialista em Ruptura Técnica

Foco em dano técnico, decomposição, interrupção, fraquezas e eliminação de ameaças.

### Especialista em Investigação

Foco em evidência, Codex, leitura de padrões, hipóteses, identificação e recompensas de conhecimento.

### Especialista em Extração

Foco em coleta, materiais raros, recursos, artefatos, amostras e otimização de grind.

### Especialista em Suporte Operacional

Foco em equipe, mitigação, preparação, protocolos, cura limitada e redução de falha.

### Especialista em Protocolos Experimentais

Foco em técnicas de alto risco, catalisadores instáveis, modificadores raros e recompensas elevadas.

### Especialista Institucional

Foco em autorizações, reputação, acesso a arquivos, missões específicas, diplomacia e decisões de relatório.

## 11.3 Mistura de Especializações

O jogador deve poder misturar especializações.

No entanto, mistura deve exigir renúncia.

Um personagem generalista pode ser flexível, mas não deve superar especialistas em seus nichos.

## 11.4 Especialização e Narrativa

Algumas especializações podem ter implicações narrativas.

Exemplos:

- usar protocolos experimentais pode aumentar desconfiança institucional;
- foco em extração pode gerar tensão ética;
- contenção prioriza segurança, mas pode reduzir coleta de amostras;
- investigação pode revelar conflitos entre Academias;
- especialização institucional pode abrir portas, mas criar dependência política.

A build deve dialogar com a história.

---

# 12. Ferramentas, Instrumentos e Equipamentos

Equipamentos em AZOTH: BREACH devem ser ferramentas alquímicas, não apenas armaduras e armas tradicionais.

## 12.1 Função dos Instrumentos

Instrumentos devem:

- alterar estilo de execução;
- modificar risco;
- melhorar leitura de campo;
- ampliar compatibilidade com ETs;
- melhorar coleta;
- abrir opções de build;
- comunicar identidade visual;
- criar chase loot.

## 12.2 Tipos de Instrumentos
...
## 12.3 Equipamento Como Build, Não Como Estatística

Um bom equipamento deve alterar decisões.
...
> ETs de linha têm maior precisão, mas ETs radiais custam mais Foco.

Exemplo ainda melhor:

> Ao estabilizar uma célula contaminada, gera um microescudo em célula adjacente, uma vez por turno.

Equipamento deve criar comportamento.

## 12.4 Raridade de Equipamentos

Raridade não deve significar apenas números maiores.

Raridade deve significar:

- regra incomum;
- sinergia rara;
- trade-off único;
- origem narrativa relevante;
- forma visual distinta;
- interação com ETs específicas;
- valor de coleção;
- possibilidade de build nova.

---

# 13. Protocolos de Campo

Protocolos de Campo são regras operacionais equipáveis ou desbloqueáveis.

Eles representam preparação, doutrina, treinamento e autorização.

## 13.1 Função dos Protocolos

Protocolos permitem que o jogador personalize postura operacional.

Exemplos:

- Protocolo de Evacuação Prioritária;
- Protocolo de Extração Segura;
- Protocolo de Contenção Rápida;
- Protocolo de Supressão de Ruído;
- Protocolo de Risco Aceitável;
- Protocolo de Preservação de Evidência;
- Protocolo de Intervenção Agressiva;
- Protocolo de Retirada Controlada.

## 13.2 Trade-offs de Protocolos

Protocolos devem ter consequências.

Exemplos:

- maior chance de salvar civis, menor chance de loot raro;
- maior coleta, maior risco;
- menor Ruído, menor dano;
- maior dano, menor estabilidade;
- melhor relatório institucional, menor autonomia;
- maior autonomia, maior desconfiança.

Protocolos conectam gameplay, narrativa e identidade.

---

# 14. Codex Como Progressão

O **Codex Veritatis** deve ser sistema de progressão, não apenas enciclopédia.

## 14.1 Conhecimento Como Poder Operacional

Completar entradas do Codex pode:

- revelar fraquezas;
- reduzir risco;
- prever efeitos de campo;
- desbloquear ETs;
- liberar diálogos;
- abrir rotas;
- melhorar extração;
...
- permitir upgrades;
- recontextualizar missões antigas.

## 14.2 Camadas de Codex e Gating

O Codex deve obedecer às camadas de revelação narrativa.

Uma entrada pode ter:
...
Cada camada pode liberar benefícios diferentes.

Antes de uma revelação narrativa, o benefício deve ser prático e limitado.

Depois da revelação, o mesmo conhecimento pode ganhar novo significado.

## 14.3 Codex e Buildcraft

O Codex pode se conectar a builds por:

- bônus contra fenômenos catalogados;
- desbloqueio de modificadores;
- maior precisão em Domínios estudados;
- redução de risco em regiões conhecidas;
- identificação de materiais raros;
- acesso a Protocolos de Campo;
- desbloqueio de especializações;
- validação de ETs experimentais.

O jogador que investe em conhecimento deve sentir poder, mas um poder diferente do jogador que investe em combate bruto.

---

# 15. Relação Entre Grind e Progressão

Grind deve estar sempre disponível e sempre ter utilidade.

Mas grind não deve ser obrigatório a ponto de bloquear campanha injustamente.

## 15.1 Função do Grind

O grind existe para:

- dar atividade infinita;
- gerar recursos;
- permitir busca por loot raro;
- sustentar experimentação;
- testar builds;
- treinar ETs;
- melhorar domínio mecânico;
- alimentar pesquisa;
- preparar missões difíceis;
- criar rotina de retorno diário;
- sustentar endgame e temporadas.

## 15.2 Grind Como Expressão de Esforço

O jogador deve sentir:

> “Meu poder veio do meu esforço.”

Esse esforço pode vir de:
...
- estudar Codex;
- experimentar builds;
- vencer Frentes de Colapso;
- completar objetivos secundários;
- aceitar trade-offs;
- refinar ETs;
- buscar chase loot.

## 15.3 Grind Não Deve Anular Habilidade

O jogo não deve permitir que grind bruto substitua completamente habilidade tática.

Um jogador que farma muito deve ter mais opções e mais consistência, mas ainda precisa:
...
Progressão deve recompensar domínio, não apenas tempo.

---

# 16. Chase Loot e Obsessão Saudável

AZOTH: BREACH deve ter loot ultrarraro, especialmente no endgame.

Esse loot deve gerar desejo, identidade e retorno de longo prazo.

## 16.1 Função do Chase Loot

Chase loot serve para:

- manter jogadores engajados;
- criar histórias pessoais;
- alimentar builds únicas;
- recompensar dificuldade;
- dar propósito ao endgame;
- sustentar temporadas;
- criar metas aspiracionais;
- gerar orgulho visual e mecânico.

## 16.2 Categorias de Chase Loot
...
- Artefatos de Convergência;
- Padrões Ômega de ET;
- Instrumentos Anômalos;
- Fragmentos de Ruínas;
- Matrizes de Transmutação raríssimas;
- Registros de Campo lacrados;
- Cosméticos sistêmicos de círculo.

## 16.3 Regras de Chase Loot

Chase loot deve:

- mudar estilo de jogo;
- ter limite de uso ou trade-off;
- não quebrar campanha;
- não revelar Camadas proibidas cedo demais;
- não virar item obrigatório único;
- permitir builds alternativas;
- ter origem narrativa plausível;
- ser emocionante de obter;
- ser reconhecível visualmente.

## 16.4 Ultra-Raros e Build Única

Um ultra-raro ideal não diz:

> “Você causa 200% mais dano.”

Ele diz:

> “Agora você pode construir uma estratégia que antes não existia.”

Exemplo:

> **Runa Irregular: Reversibilidade Parcial**  
> Quando uma ET de estabilização reduz instabilidade de uma Breach, parte do custo operacional retorna como Foco. Porém, se a ET falhar, o Ruído gerado aumenta.

Isso cria build, risco e identidade.

---

# 17. Progressão Regional e Institucional

O jogador não progride apenas como indivíduo.

Ele progride dentro de Aletheia, das Academias e das regiões.

## 17.1 Progressão Regional
...
Mas também pode criar obrigações:

- restrições de relatório;
- pressão política;
- perda de autonomia;
- exigência de preservação de evidência;
- conflitos entre Academias;
- censura parcial.

## 17.3 Relação Entre Instituição e Build

Vínculos institucionais podem favorecer estilos.

Exemplo:

- uma Academia favorece contenção e segurança;
- outra favorece pesquisa e Codex;
- outra favorece extração e artefaturia;
- outra favorece protocolos experimentais;
- outra favorece intervenção agressiva.

O jogador deve poder se aproximar de instituições sem ser forçado a uma só rota definitiva cedo demais.

---

# 18. Progressão de Campanha

A campanha deve liberar progressão por marcos.

## 18.1 Marcos de Campanha

Marcos podem liberar:

- novas regiões;
- novos companheiros;
- novas categorias de ET;
- novas camadas de Codex;
...
- novos riscos;
- novas Frentes;
- mudança de regime narrativo.

## 18.2 Progressão Compatível com Revelação

Antes de uma revelação, o sistema pode mostrar efeitos práticos sem explicar toda a causa.

Depois da revelação, o sistema pode recontextualizar esses efeitos.

Exemplo:

Antes:

> “Anomalia de leitura instável.”

Depois:

> “Padrão compatível com hipótese restrita já desbloqueada.”

Isso preserva mistério e recompensa conhecimento.

## 18.3 Progressão Por Recontextualização

Um dos prazeres centrais deve ser voltar a sistemas antigos com entendimento novo.

Exemplos:

- uma região inicial revela nova camada;
- uma ET básica ganha aplicação avançada;
- um inimigo comum passa a indicar fenômeno maior;
- um material antes simples vira componente de pesquisa;
- um relatório antigo mostra contradição.

Progressão em AZOTH deve frequentemente dizer:

> “Você já viu isso antes, mas agora entende melhor.”

---

# 19. Progressão de Endgame

Endgame é a camada em que buildcraft, grind e domínio sistêmico se tornam centrais.

## 19.1 Frentes de Colapso

Frentes de Colapso são atividades de alto risco e alta recompensa.

Elas devem permitir:

- runs repetíveis;
- aumento progressivo de risco;
- decisão de extrair ou continuar;
- modificadores variáveis;
- chance de loot ultrarraro;
- teste extremo de builds;
- recompensas sazonais;
- recontextualização pós-revelação.

## 19.2 Progressão Pós-Campanha

Após a campanha, progressão deve focar em:
...
- Codex pós-revelação;
- temporadas;
- desafios de alta instabilidade;
- maestria tática;
- variações cosméticas e funcionais.

## 19.3 Endgame Não é Apenas Números

Endgame deve oferecer:

- novas regras de campo;
- novos objetivos;
- novos riscos;
- novas combinações;
- novas leituras de Codex;
- novas rotas de build;
- novas decisões de extração;
- novas relações com instituições;
- novas consequências regionais.

Aumentar vida e dano de inimigos não é suficiente.

---

# 20. Temporadas e Progressão Sazonal

Temporadas devem ser integradas ao mundo.

Elas não devem parecer eventos cosméticos genéricos.

## 20.1 Função das Temporadas

Temporadas servem para:

- renovar operações;
- introduzir modificadores temporários;
- criar metas de médio prazo;
- oferecer loot sazonal;
- testar builds;
- ampliar Codex;
- trazer linhas narrativas curtas;
- manter o jogo vivo.

## 20.2 Exemplos de Temporadas

### Maré de Ruído

Regiões específicas têm Ruído Informacional elevado.

Recompensas possíveis:

- runas instáveis;
- catalisadores ruidosos;
- padrões visuais de círculo;
- entradas temporárias do Codex;
- operações de contenção difíceis.

### Arquivos Lacrados

Foco em investigação, arquivos, ruínas e hipóteses restritas.
...
- ETs de análise;
- modificadores de Informação.

### Fendas de Umbra

Foco em combate, extração e sobrevivência.
...
## 20.3 Progressão Sazonal Sem Reset Destrutivo

Temporadas não devem apagar o esforço principal do jogador.
...
Mas não devem exigir que o jogador refaça toda progressão base.

---

# 21. Buildcraft: Regras de Design

Buildcraft é a arte de permitir que o jogador construa soluções próprias.

## 21.1 Regra da Autoria

O jogador deve conseguir olhar para sua build e dizer:

> “Isso é meu.”

Para isso, o jogo precisa permitir:

- escolhas permanentes ou semipermanentes;
- experimentação reversível;
- combinações não óbvias;
- trade-offs reais;
- identidade visual;
- especializações;
- chase loot;
- variações de ET;
- diferentes prioridades de missão.

## 21.2 Regra da Legibilidade

Buildcraft profundo precisa ser legível.

O jogador deve entender:

- por que uma escolha melhora algo;
- que risco ela aumenta;
- que sinergia ela abre;
- que custo ela impõe;
- que tipo de missão favorece;
- que tipo de inimigo combate;
- que tipo de campo prejudica.

Sem legibilidade, buildcraft vira planilha opaca.

## 21.3 Regra do Trade-off

Toda escolha forte deve ter custo.

Custos possíveis:

- maior Ruído;
- menor precisão;
- maior custo de catalisador;
- menor área;
- menor duração;
- mais tempo de execução;
- maior risco de falha;
- menor recompensa institucional;
- maior dano colateral;
- menor coleta;
- menor defesa.

Sem trade-off, haverá build dominante.

## 21.4 Regra da Viabilidade Múltipla

O jogo deve permitir várias builds viáveis.
...
- Defesa e evacuação;
- Build de Frentes de Colapso;
- Build de farm de materiais;
- Build de Codex.

Nenhuma deve ser sempre a melhor.

---

# 22. Arquétipos de Build Recomendados

Esta seção define arquétipos conceituais, não classes finais.

## 22.1 Contenção Segura
...
- controle de risco;
- proteção de civis;
- missões de campanha difíceis.

Fraqueza:

- menor velocidade;
- menor recompensa de extração;
- menor dano.

## 22.2 Ruptura Agressiva
...
- maior Ruído;
- menor segurança;
- maior chance de dano colateral.

## 22.3 Controle de Terreno
...
- depende de grid e posicionamento;
- pode sofrer em mapas abertos ou objetivos móveis.

## 22.4 Extração Gananciosa
...
- maior exposição;
- menor segurança;
- decisões de extração mais difíceis.

## 22.5 Investigação Analítica
...
- vantagens contra fenômenos catalogados.

Fraqueza:

- menos poder bruto;
- exige preparação e conhecimento.

## 22.6 Protocolo Experimental
...
- depende da equipe;
- menos impacto direto sozinho.

---

# 23. Respec, Experimentação e Compromisso

Buildcraft precisa permitir teste.

Mas escolhas devem ter peso.

## 23.1 Respec Parcial

O jogador deve poder ajustar builds sem punição extrema.

Recomendação:

- trocar ETs livremente no hub;
- trocar equipamentos no hub;
- alterar modificadores com custo moderado;
- desfazer especializações básicas com custo;
- preservar algumas escolhas avançadas como compromissos fortes;
- permitir slots de loadout.

## 23.2 Laboratório de Teste

O jogo deve ter um ambiente seguro para testar ETs e builds.

Esse laboratório pode permitir:

- simular inimigos conhecidos;
- testar geometria;
- comparar custo;
- ver risco estimado;
- validar ET experimental;
- salvar presets.

Isso é especialmente importante porque o jogo depende de buildcraft.

## 23.3 Compromissos de Longo Prazo

Algumas escolhas devem ser mais pesadas:

- especializações avançadas;
- vínculo institucional profundo;
- uso recorrente de protocolos restritos;
- refinamento raro de ET;
- artefatos ultrarraros vinculados;
- decisões narrativas.

Essas escolhas criam identidade.

---

# 24. Progressão e Dificuldade

Progressão deve interagir com dificuldade sem substituí-la.

## 24.1 Campanha

Na campanha, progressão deve permitir:

- superar desafios;
- reduzir frustração;
- abrir soluções alternativas;
- adaptar-se a regiões;
- preparar-se para picos de dificuldade.

Mas campanha não deve exigir farm excessivo.

## 24.2 Grind

No grind, progressão deve permitir:

- eficiência;
- maior risco voluntário;
- melhor extração;
...
No endgame, progressão deve permitir:

- enfrentar modificadores extremos;
- criar builds especializadas;
- buscar ultra-raros;
- competir opcionalmente;
- explorar Frentes de Colapso;
- avançar em temporadas.

Endgame deve testar domínio, não apenas inventário.

---

# 25. Progressão Sem Pay-to-Win

Caso o jogo tenha monetização futura, progressão não deve ser vendida de forma que destrua mérito.

A visão de progressão depende do sentimento:

> “Meu poder veio do meu esforço.”

Portanto, a monetização não deve vender:

- chase loot funcional direto;
- ultra-raros com vantagem;
- atalhos que invalidem grind;
- poder competitivo;
- materiais impossíveis de obter jogando;
- desbloqueios narrativos críticos.

Itens cosméticos, conveniência moderada e conteúdo expansivo podem ser avaliados depois, mas não pertencem a este documento.

---

# 26. Riscos de Design

## 26.1 Risco: Build Única Dominante

Se uma combinação for claramente melhor em tudo, o buildcraft morre.
...
- inimigos diferentes;
- campos diferentes;
- objetivos não centrados só em dano;
- balanceamento contínuo.

## 26.2 Risco: Progressão Numérica Excessiva

Se números escalam demais, Breach perde ameaça.

Mitigação:

- teto de poder vertical;
- foco em poder horizontal;
- riscos percentuais ou estruturais;
- objetivos que não se resolvem com dano;
- Frentes com modificadores qualitativos.

## 26.3 Risco: Grind Obrigatório Demais

Se o jogador precisa farmar muito para continuar a história, a campanha perde ritmo.

Mitigação:

- campanha balanceada para progresso normal;
- grind como vantagem, não exigência absoluta;
- recompensas garantidas parciais;
- pity systems moderados para recursos essenciais;
- raros reservados para otimização e endgame.

## 26.4 Risco: Buildcraft Opaco

Se o jogador não entende o que está acontecendo, vai copiar build ou abandonar.
...
## 26.5 Risco: Lore Bloquear Diversão

Se toda restrição canônica virar trava excessiva, o jogo fica engessado.
...
- feedback claro;
- ETs versáteis;
- exceções justificadas como protocolos, não quebras;
- diversidade de objetivos;
- recompensas frequentes.

Cânone deve orientar diversão, não sufocá-la.

---

# 27. Decisões Fechadas neste Documento

Este documento estabelece como decisões oficiais da série `04`:

1. Progressão em AZOTH: BREACH é composta por múltiplos eixos, não apenas nível.
2. O jogador deve sentir que poder vem de esforço, conhecimento, grind, teste de builds e domínio mecânico.
3. A progressão deve priorizar poder horizontal e condicional, com poder vertical controlado.
4. Builds são compostas por agente, equipe, ETs, modificadores, runas, geometrias, catalisadores, instrumentos, protocolos, Codex e vínculos institucionais.
5. ETs devem poder se tornar assinaturas de build.
6. Especializações devem definir estilo de alquimista operacional, não classes rígidas.
7. Codex é progressão sistêmica e deve transformar conhecimento em capacidade operacional.
8. Grind permanente é parte essencial da progressão.
9. Chase loot ultrarraro é desejável, especialmente no endgame, desde que altere estilo sem quebrar cânone.
10. Frentes de Colapso são a principal arena de teste e progressão avançada.
11. Temporadas devem oferecer progressão integrada ao mundo, não eventos genéricos desconectados.
12. Respec e experimentação devem existir, mas escolhas avançadas precisam ter peso.
13. Progressão não pode antecipar revelações narrativas nem violar as Leis Fundamentais.
14. Nenhum item, especialização ou nível pode abolir custo, risco, matéria, energia, instabilidade ou limite de informação.

---

# 28. Decisões Deixadas para Documentos Posteriores

Este documento não fecha:

- número final de níveis;
- custo de upgrades;
- drop rates;
- fórmulas de XP;
- tabelas de raridade;
- quantidade de slots;
- árvores finais de especialização;
...
- regras finais de monetização;
- funcionamento matemático de respec;
- duração de temporadas;
- escala final do endgame.
...
A progressão de AZOTH: BREACH será bem-sucedida se o jogador sentir, ao longo de toda a experiência:

- que sempre há algo útil para fazer;
- que cada operação pode gerar avanço;
- que conhecimento importa;
- que grind tem propósito;
- que loot raro pode mudar builds;
- que builds diferentes são viáveis;
- que poder foi conquistado, não entregue;
- que escolhas têm consequência;
- que ETs são ferramentas próprias, não apenas botões de dano;
- que o Codex altera sua leitura do mundo;
- que endgame testa domínio real;
- que temporadas renovam metas;
- que a campanha não foi quebrada pelo grind;
- que o universo permanece coerente mesmo quando a build fica poderosa.

O objetivo final é que o jogador diga:

> **“Eu não apenas subi de nível. Eu me tornei um tipo específico de alquimista, construído pelas minhas escolhas, pelo meu conhecimento e pelo meu esforço.”**

---

# 30. Encerramento

`AZOTH_04.5_Progressao_do_Jogador_Builds_e_Especializacao_v0.1.md` define como crescimento, poder e identidade mecânica devem funcionar em AZOTH: BREACH.

Ele estabelece que progressão não é fuga dos limites do mundo. É aprofundamento de competência dentro deles.

O jogador cresce porque aprende, testa, falha, coleta, pesquisa, refina e decide.

A próxima etapa natural da série é `AZOTH_04.6_Recursos_Crafting_Pesquisa_e_Economia_de_Sistemas_v0.1.md`, que deverá detalhar os recursos, materiais, crafting, artefaturia, pesquisa aplicada, custos, circulação econômica e sustentação material de todo o sistema de progressão definido aqui.
<!-- FIM: docs/04_gameplay/AZOTH_04.5_Progressao_do_Jogador_Builds_e_Especializacao_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.6_Recursos_Crafting_Pesquisa_e_Economia_de_Sistemas_v0.1.md -->
...
<!-- FIM: docs/04_gameplay/AZOTH_04.6_Recursos_Crafting_Pesquisa_e_Economia_de_Sistemas_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.7_Coop_Competicao_e_Interacao_Multijogador_v0.1.md -->
# AZOTH: BREACH — Documento 04.7 — Coop, Competição e Interação Multijogador
## Documento de Cooperação Sistêmica, Competição Controlada e Coexistência entre Jogadores

**Série:** 04 — Gameplay  
**Código:** AZOTH_04.7  
**Título:** Coop, Competição e Interação Multijogador  
**Versão:** v0.1  
**Status:** Documento inicial consolidado  
**Documento anterior:** `AZOTH_04.6_Recursos_Crafting_Pesquisa_e_Economia_de_Sistemas_v0.1.md`  
**Função:** Definir interação social, cooperação, competição controlada, contribuição coletiva, limites de troca e coexistência entre jogadores sem romper o cânone nem subordinar a experiência solo ao multiplayer.

---

# 1. Função deste Documento

Este documento define como múltiplos jogadores podem coexistir, cooperar, competir, compartilhar progresso indireto, contribuir para eventos sazonais e participar de atividades sociais dentro de **AZOTH: BREACH** sem quebrar o cânone, sem destruir o equilíbrio do jogo solo e sem transformar a experiência em um produto dependente de infraestrutura multiplayer complexa desde o início.

A função deste documento é estabelecer:

- princípios de interação multijogador;
- limites canônicos para cooperação e competição;
- papel de atividades assíncronas;
- possíveis formatos de cooperação em tempo real;
- formatos de competição compatíveis com o universo;
- uso de rankings, temporadas e eventos coletivos;
- regras para troca, empréstimo e compartilhamento de recursos;
- relação entre multiplayer, campanha, grind, endgame e Codex;
- prioridades de escopo para desenvolvimento solo com apoio de IA.

Este documento não define netcode, arquitetura de servidor, matchmaking final, monetização, anti-cheat técnico, contratos de API ou implementação de backend. Esses temas pertencem a documentação futura de produto, tecnologia, live service e operação.
...
3. `02 — Lore`
4. `03 — Narrativa`
5. `04.0 — Arquitetura do Gameplay`
6. `04.1 — Core Loop e Estrutura de Progressão`
7. `04.2 — Transmutação Como Sistema de Jogo`
8. `04.3 — Combate, Funções Táticas e Resolução`
9. `04.4 — Exploração, Mundo Jogável e Estruturas de Campo`
10. `04.5 — Progressão do Jogador, Builds e Especialização`
11. `04.6 — Recursos, Crafting, Pesquisa e Economia de Sistemas`

Multiplayer não pode:

- criar cosmologia paralela;
- tratar jogadores como escolhidos únicos;
- transformar cooperação entre realidades em explicação para Sincronias Ômni-Temporais;
- antecipar a Verdade antes das camadas narrativas autorizadas;
- permitir domínio completo da Verdade por jogadores;
- permitir transmutação sem Máquina de Execução;
- permitir que jogadores ignorem conservação de massa-energia;
- vender ou trocar poder que trivialize campanha;
- transformar competição em massacre canônico entre alquimistas sem consequência institucional;
- destruir a experiência solo como eixo principal do jogo.

Multiplayer deve respeitar a premissa central:

> **o jogador é um agente alquímico competente, mas limitado, atuando em um mundo instável, institucionalmente disputado e epistemologicamente incompleto.**

---

# 3. Princípio Central do Multiplayer

O princípio central do multiplayer em AZOTH: BREACH é:

> **interação entre jogadores deve ampliar coordenação, comparação, comunidade, especialização e recorrência sem substituir a campanha solo nem reduzir o universo a lobby, arena ou economia de troca.**

AZOTH não deve ser desenhado como MMO.

AZOTH não deve depender de jogadores online para ser divertido.

AZOTH não deve obrigar cooperação para progressão principal.

AZOTH pode, porém, usar interação multijogador para reforçar três fantasias importantes:

1. **Cooperação de crise** — alquimistas diferentes coordenando resposta a Breaches.
2. **Competição acadêmica** — agentes comparando eficiência, descobertas e prestígio.
3. **Contribuição coletiva** — jogadores somando relatórios, amostras e operações para estabilizar eventos sazonais.

A regra de ouro é:

> **solo-first, multiplayer-enhanced.**

---

# 4. Escopo Recomendado para Desenvolvimento Solo

Como AZOTH: BREACH está sendo concebido para construção solo com apoio de IA, multiplayer deve ser organizado por camadas de complexidade.

## 4.1 Camada 1 — Assíncrona

Prioridade máxima.

Pode existir sem combate simultâneo entre jogadores.
...
- relatórios públicos de operação;
- eventos globais de contribuição;
- comparação de eficiência;
- simulações com seed fixa;
- espectros de builds de outros jogadores;
- empréstimo limitado de suporte;
- guildas leves ou células de campo;
- contribuições coletivas para Frentes de Colapso.

Esta camada é a mais viável para MVP, early access e live ops inicial.

## 4.2 Camada 2 — Coop Indireto

Complexidade média.

Jogadores não atuam no mesmo grid em tempo real, mas influenciam a operação uns dos outros.

Inclui:

- envio de suprimentos;
- reforço institucional;
- registro de ET recomendada;
- suporte remoto de outro jogador;
- operação em cadeia;
- missão comunitária em fases;
- contribuição para estabilidade regional compartilhada;
- envio de dados para pesquisa de grupo.

## 4.3 Camada 3 — Coop Síncrono

Complexidade alta.

Deve ser considerada depois que o jogo solo estiver sólido.
...
- Frentes Conjuntas;
- raids táticas leves;
- combate em grid com turnos coordenados;
- papéis complementares em contenção, análise, extração e suporte.

## 4.4 Camada 4 — Competição Direta

Complexidade alta e risco de design alto.

Não deve ser prioridade inicial.

Se existir, deve acontecer preferencialmente como:

- simulação acadêmica;
- exercício controlado;
- disputa de eficiência;
- corrida de contenção;
- comparação de score;
- modo tático sem impacto canônico letal.

PvP direto, caso exista, deve ser cuidadosamente limitado e provavelmente não deve ser o centro do jogo.

---

# 5. Decisão Estrutural: Solo-First

A campanha principal de AZOTH: BREACH deve ser completamente jogável solo.

Nenhuma missão principal deve exigir:
...
- item obtido exclusivamente por multiplayer.

O jogador solo deve conseguir:

- completar a campanha;
- entender a narrativa;
- construir builds profundas;
- acessar grind permanente;
- chegar ao endgame;
- obter chase loot equivalente por caminhos solo;
- participar de temporadas em escala individual.

Multiplayer deve ser uma camada de reforço, não uma dependência estrutural.

---

# 6. Justificativa Canônica para Interação entre Jogadores

Aletheia já contém justificativas fortes para interação entre múltiplos agentes:

- Academias formam muitos alquimistas;
- operações de campo exigem equipes;
- Breaches podem ocorrer simultaneamente em várias regiões;
- Conselho Interacadêmico coordena respostas a crises;
- Academias competem por prestígio, recursos e interpretação;
- após certas revelações, cooperação torna-se necessidade existencial;
- Frentes de Colapso exigem resposta distribuída;
- Codex Veritatis depende de catalogação progressiva e registros de campo.

Portanto, múltiplos jogadores podem ser tratados como:

- agentes de campo distintos;
- especialistas de Academias diferentes;
- operadores em células paralelas;
- pesquisadores contribuindo para bancos de dados;
- equipes atuando em diferentes focos de uma crise maior;
- participantes de protocolos de simulação acadêmica;
- membros de frentes interacadêmicas no endgame.

O jogo não deve sugerir que todos os jogadores são “o mesmo protagonista”.

Em termos de experiência, cada jogador vive sua própria campanha. Em termos sistêmicos, interações sociais representam cooperação ou comparação entre agentes de campo dentro do mesmo período histórico jogável.

---

# 7. Identidade Multiplayer de AZOTH

Multiplayer em AZOTH deve ser reconhecível por três palavras:

1. **Coordenação**
2. **Prestígio**
3. **Contribuição**

Não deve ser definido por:

- dano por segundo;
- arena infinita;
- economia predatória;
- loot obrigatório de raid;
- poder vendido;
- competição tóxica;
- obrigação diária punitiva.

A experiência social deve fazer o jogador pensar:

> “Minha build, minhas descobertas e meu desempenho podem ajudar, impressionar ou competir com outros agentes.”

Não:

> “Preciso jogar online ou meu personagem fica inútil.”

---

# 8. Tipos de Interação Multijogador

AZOTH deve organizar multiplayer em categorias claras.

## 8.1 Interação Assíncrona

Jogadores interagem por registros, dados, placares, contribuições e builds compartilhadas.

Exemplos:

- publicar loadout de ETs;
- comparar eficiência em operação fixa;
- contribuir para meta global de temporada;
- enviar recurso limitado para célula de campo;
- registrar descoberta no banco coletivo;
- ver estatísticas de builds populares;
- desafiar seed semanal com mesmos modificadores.

## 8.2 Interação Cooperativa

Jogadores trabalham para objetivo comum.

Exemplos:

- operação em dupla;
- operação por papéis complementares;
- estabilização compartilhada de Frente de Colapso;
- extração de amostras com risco crescente;
- missão em cadeia onde cada jogador resolve uma etapa.

## 8.3 Interação Competitiva

Jogadores comparam desempenho sob regras controladas.

Exemplos:

- menor instabilidade final;
- maior extração sem colapso;
- melhor contenção em poucos turnos;
- maior score de precisão;
- menor custo de recursos;
- melhor taxa de preservação civil;
- ranking sazonal de simulação.

## 8.4 Interação Econômica Limitada

Jogadores trocam, doam, emprestam ou convertem recursos com limites.

Exemplos:

- doação a célula;
- troca de reagentes comuns;
- empréstimo temporário de instrumento não ultrarraro;
- compartilhamento de receita descoberta;
- contribuição para pesquisa coletiva;
- mercado institucional controlado.

## 8.5 Interação Social

Jogadores formam grupos, seguem builds, comentam relatórios e coordenam temporadas.

Exemplos:

- células de campo;
- cátedras de pesquisa;
- círculos interacadêmicos;
...
A principal estrutura social recomendada é a **Célula de Campo**.

Uma Célula de Campo é um grupo pequeno ou médio de jogadores que compartilha objetivos, progresso sazonal e identidade operacional.

Ela funciona como guilda leve, mas com linguagem do universo.

## 9.1 Função das Células

Células podem:

- acumular reputação;
- participar de metas coletivas;
- desbloquear cosméticos institucionais;
- contribuir com pesquisa;
- comparar desempenho interno;
- organizar operações cooperativas;
- compartilhar builds;
- gerar relatórios coletivos;
- participar de Frentes de Colapso sazonais.

## 9.2 Limites das Células

Células não devem:

- bloquear campanha;
- conceder poder obrigatório;
- controlar mercado essencial;
- exigir presença diária;
- criar vantagem impossível para jogadores solo;
- liberar Verdade antes da progressão narrativa individual.

## 9.3 Tamanho Recomendado

A documentação high-level não fixa número final, mas recomenda que Células sejam pensadas como grupos gerenciáveis, não mega-guildas.

Escopos possíveis:

- célula pequena: 3 a 6 jogadores;
- célula média: 8 a 20 jogadores;
- célula ampliada: 30 a 50 jogadores para live ops maduro.

Para desenvolvimento inicial, célula pequena ou média é mais segura.

---

# 10. Identidade Acadêmica e Multiplayer

A filiação acadêmica pode ser usada como camada de identidade social e competitiva.

O jogador pode se identificar com uma Academia, mas isso não deve aprisionar toda a build.

## 10.1 Funções da Filiação

Filiação pode influenciar:

- títulos;
- moldura de perfil;
- estética de círculo;
- desafios acadêmicos;
- rankings por Academia;
- eventos de prestígio;
- linhas de pesquisa favorecidas;
- pequenas bonificações condicionais;
- acesso narrativo a relatórios específicos.

## 10.2 Competição entre Academias

Competição acadêmica deve representar:
...
Não deve representar guerra total permanente.

As Academias podem competir por glória quando há descoberta, mas cooperar quando há ameaça maior.

## 10.3 Troca de Filiação

O jogo pode permitir troca de filiação com custo narrativo/sistêmico moderado, ou permitir múltiplas afinidades.

Não deve punir permanentemente o jogador por escolher uma Academia inicial sem entender o jogo.

---

# 11. Coop Assíncrono

Coop assíncrono é a forma mais recomendada de multiplayer inicial.

Ele permite sensação de comunidade sem exigir sincronização em tempo real.

## 11.1 Relatórios Compartilhados

Jogadores podem publicar relatórios de operação contendo:
...
Relatórios compartilhados servem para:

- aprendizado comunitário;
- comparação;
- inspiração de build;
- registro de conquista;
- contribuição narrativa leve.

## 11.2 Ecos de Campo

Um jogador pode encontrar, em operações repetíveis, vestígios abstratos de outros agentes.

Exemplos:

- círculo parcialmente apagado;
- instrumento quebrado;
- anotação de campo;
- marca de contenção anterior;
- recomendação de ET;
- aviso sobre risco;
- amostra deixada para recuperação.

Esses Ecos não significam fantasma, viagem temporal ou multiverso ativo. São registros operacionais e vestígios de outros agentes atuando em zonas instáveis.

## 11.3 Suporte Remoto

Um jogador pode designar um pacote de suporte para outro jogador ou para membros da Célula.

Exemplos:

- análise prévia de Breach;
- suprimento de catalisador comum;
- redução pequena de custo de extração;
- aumento temporário de chance de amostra;
- recomendação de rota;
- uma intervenção de suporte por operação.

Suporte remoto deve ser limitado e não pode vencer a missão sozinho.

## 11.4 Pesquisa Coletiva

Jogadores podem contribuir com dados para objetivos coletivos.

Exemplos:

- catalogar 1.000 amostras de Ruído Cristalino durante a temporada;
- estabilizar 50.000 focos menores de uma Frente;
- completar relatórios de anomalias em três regiões;
- reconstruir uma ET sazonal por fragmentos de comunidade.

A recompensa deve ser:

- cosmética;
- narrativa leve;
- acesso temporário a desafio;
- recurso comum/médio;
- título;
- pequena melhoria de conveniência;
- desbloqueio de pesquisa individual baseado em contribuição mínima.

---

# 12. Coop Síncrono

Coop síncrono deve ser tratado como expansão futura, não requisito do núcleo.

Se implementado, deve preservar legibilidade, ritmo tático e autoria de build.

## 12.1 Tamanho de Grupo Recomendado

AZOTH não deve usar grupos grandes no combate comum.

Formatos recomendados:

- dupla: 2 jogadores;
- trio: 3 jogadores;
- célula tática especial: até 4 jogadores apenas em conteúdo específico.

Acima disso, o grid, o tempo de espera e a leitura de transmutação tendem a piorar.

## 12.2 Estrutura de Turno em Coop

Existem dois modelos possíveis.

### Modelo A — Turno Compartilhado

Todos os jogadores agem durante a fase da equipe.

Vantagens:

- mais coordenação;
- menor espera;
- sensação de operação conjunta.

Riscos:

- conflito de ordem;
- jogador dominante comandando tudo;
- necessidade de travas de confirmação.

### Modelo B — Iniciativa Individual

Cada agente tem sua vez.
...
- espera longa;
- operação mais lenta;
- menos fluidez em mobile.

Decisão recomendada para futuro:

> **turno compartilhado com confirmação individual e janela de planejamento.**

## 12.3 Papéis Cooperativos

Coop deve recompensar papéis complementares.
...
- Suporte Operacional;
- Controle de Risco;
- Interrupção de Fenômeno.

A melhor operação coop deve fazer o grupo pensar:

> “Não precisamos de três builds iguais. Precisamos coordenar funções.”

## 12.4 Combos de ETs entre Jogadores

Coop pode permitir sinergia entre ETs, mas com limites.

Exemplos:

- um jogador estabiliza terreno, outro executa ET de alta complexidade;
- um jogador revela estado oculto, outro usa extração precisa;
- um jogador contém foco de Breach, outro purifica resíduo;
- um jogador cria barreira, outro desloca ameaça para célula segura;
- dois jogadores reduzem Ruído de uma execução experimental.

Combos não devem criar fusões mágicas sem especificação.

A sinergia deve ser descrita como:

- preparação;
- validação assistida;
- estabilização complementar;
- redução de risco;
- leitura de campo compartilhada;
- execução sequencial de ETs compatíveis.

## 12.5 Falha em Coop

Falha em coop deve ser responsabilidade sistêmica, não punição social destrutiva.

Falhas podem gerar:

- aumento de instabilidade;
- perda parcial de amostra;
- dano de campo;
- bloqueio temporário de célula;
- necessidade de extração antecipada;
- redução de score.

Não deve gerar:

- perda permanente extrema;
- roubo entre jogadores;
- destruição de build;
- punição severa por erro de conexão;
- clima de hostilidade.

---

# 13. Operações Cooperativas

Operações cooperativas devem ser variações especiais das estruturas já definidas em `04.4`.

## 13.1 Tipos de Operação Coop

### 13.1.1 Contenção Coordenada

Dois ou mais focos de Breach exigem ações simultâneas ou sequenciais.

Objetivo:

- estabilizar múltiplos pontos;
- impedir propagação cruzada;
- coordenar selagens.

### 13.1.2 Extração de Alto Risco

Um jogador segura ameaça ou instabilidade enquanto outro coleta amostra.

Objetivo:

- extrair material raro;
- manter integridade da amostra;
- decidir momento de retirada.

### 13.1.3 Ruína Compartilhada

Jogadores resolvem obstáculos em áreas diferentes da mesma ruína.
...
### 13.1.4 Resgate de Célula

Um grupo precisa salvar pesquisadores, civis ou agentes presos.

Objetivo:

- priorizar vidas;
- conter risco;
- extrair sobreviventes;
- preservar evidência quando possível.

### 13.1.5 Frente Conjunta

Conteúdo de endgame em que jogadores atuam em sequência de eventos táticos com instabilidade crescente.
...
## 13.2 Duração Recomendada

Operações coop devem ser mais curtas do que raids tradicionais.

Recomendação conceitual:

- coop rápido: 8 a 15 minutos;
- coop médio: 15 a 25 minutos;
- Frente Conjunta: 20 a 40 minutos, com pontos de extração.

Evitar missões longas demais em mobile.

---

# 14. Frentes Conjuntas de Colapso

As Frentes Conjuntas são o principal formato coop de endgame.

Elas representam crises que excedem a capacidade de uma única equipe.

## 14.1 Estrutura

Uma Frente Conjunta pode ter:

1. briefing interacadêmico;
2. escolha de papel;
3. modificadores de instabilidade;
4. sequência de confrontos ou eventos;
5. objetivos principais e secundários;
6. pontos de extração;
7. risco crescente;
8. recompensa por profundidade;
9. relatório final coletivo.

## 14.2 Push Your Luck em Grupo

O grupo deve decidir junto:

- extrair agora com ganhos seguros;
- avançar para chance de loot melhor;
- tentar objetivo opcional;
- sacrificar amostra para reduzir risco;
- aceitar mutador perigoso por recompensa maior.

Essa decisão reforça a fantasia de operação de crise.

## 14.3 Recompensas

Frentes Conjuntas podem conceder:

- materiais de endgame;
- registros raros;
- fragmentos de ET;
- cosméticos de célula;
- títulos;
- runas condicionais;
- instrumentos com origem da Frente;
- componentes para crafting experimental;
- progressão sazonal.

Não devem conceder poder obrigatório exclusivo que inviabilize jogadores solo.

---

# 15. Competição em AZOTH

Competição deve existir, mas precisa respeitar o tom do universo.

A competição mais natural em AZOTH não é matar outros jogadores.

É provar competência.

## 15.1 Eixos de Competição

Jogadores podem competir por:
...
- qualidade do relatório;
- dificuldade vencida;
- criatividade de build;
- contribuição coletiva.

## 15.2 Competição Acadêmica

Academias podem disputar rankings sazonais.

Exemplos:

- Academia com maior taxa de contenção;
- Academia com mais dados catalogados;
- Academia com maior eficiência em ruínas;
- Academia com menor custo médio por operação;
- Academia com maior contribuição contra uma Frente.

Essa competição deve gerar:

- prestígio;
- cosméticos;
- títulos;
- narrativa sazonal;
- pequenas recompensas coletivas.

Não deve gerar:

- superioridade permanente;
- bloqueio de conteúdo;
- humilhação de jogadores de Academias menores;
- snowball irreversível.

## 15.3 Rankings Individuais

Rankings individuais podem existir para desafios específicos.

Categorias recomendadas:

- contenção mais limpa;
- extração mais profunda;
- menor instabilidade;
- maior dificuldade vencida;
- menor custo;
- maior preservação civil;
- melhor score semanal;
- melhor uso de ET específica.

Rankings devem ser separados por bracket quando necessário.

Exemplos de brackets:

- campanha inicial;
- midgame;
- endgame;
- sem ultrarraros;
- desafio com loadout fixo;
- desafio aberto;
- temporada atual.

## 15.4 Competição de Build

O jogo pode incentivar competição indireta de builds.

Exemplos:

- build mais usada em determinada Frente;
- build com maior taxa de sucesso;
- build mais eficiente em custo;
- build mais estável;
- build com maior risco/recompensa;
- build votada pela comunidade;
- build destacada por desenvolvedor.

Isso reforça o objetivo do jogador sentir que construiu uma identidade própria.

---

# 16. PvP Direto

PvP direto é opcional, arriscado e não deve ser prioridade.

Se existir, deve ser justificado como:

- simulação acadêmica;
- duelo de protocolo;
- exercício de contenção;
- arena de teste;
- disputa controlada por instituição;
- reconstrução não letal de cenário tático.

## 16.1 Por Que PvP é Arriscado

PvP direto pode causar:

- balanceamento impossível entre builds PvE e PvP;
- toxicidade;
- pressão por meta rígido;
- monetização predatória;
- frustração;
- redução do tom narrativo;
- foco excessivo em dano;
- descaracterização da alquimia como técnica de campo.

## 16.2 Regras Caso Exista

PvP direto deve:

- ser separado do balanceamento PvE;
- usar simulações;
- evitar perda permanente;
- normalizar poder quando necessário;
- limitar ultrarraros;
- premiar cosméticos e prestígio mais do que poder;
- evitar ranqueamento obrigatório;
- permitir desistência sem punição severa.

## 16.3 Formatos Mais Compatíveis

Formatos melhores que combate livre:

- corrida de contenção em arenas espelhadas;
- disputa de extração com risco idêntico;
- simulação de menor instabilidade;
- puzzle tático competitivo;
- draft de ETs em simulação;
- combate indireto contra mesma ameaça;
- score attack semanal.

Decisão recomendada:

> **PvP direto não é escopo inicial. Competição assíncrona e simulações comparativas são prioridade.**

---

# 17. Simulações Acadêmicas

Simulações Acadêmicas são a forma mais segura de competição.

Elas permitem comparar jogadores sem quebrar cânone.
...
- testar builds;
- criar rankings;
- oferecer desafios semanais;
- permitir competição justa;
- separar campanha de balanceamento competitivo;
- justificar cenários repetidos;
- permitir mutadores experimentais.

## 17.2 Tipos de Simulação

### 17.2.1 Simulação de Loadout Fixo

Todos usam a mesma build.

Mede habilidade tática.

### 17.2.2 Simulação de Build Aberta

Jogadores usam suas próprias builds.

Mede progressão, criatividade e otimização.

### 17.2.3 Simulação de Restrição

O jogo impõe restrições.

Exemplos:

- sem catalisadores raros;
- apenas ETs de contenção;
- instabilidade elevada;
- sem instrumentos anômalos;
- limite de ações;
- objetivo de extração.

### 17.2.4 Simulação de Temporada

Desafio tem mutadores sazonais.

Exemplo:

- Ruído Informacional aumentado;
- Breaches energéticas instáveis;
- amostras orgânicas degradáveis;
- instrumentos com falha parcial;
- campo com geometria irregular.

## 17.3 Recompensas

Simulações devem premiar:
...
- marcas de perfil;
- padrões visuais;
- acesso a desafios superiores.

Evitar recompensas obrigatórias de poder.

---

# 18. Compartilhamento de Builds

Compartilhamento de build é uma funcionalidade social importante.

AZOTH deve permitir que jogadores mostrem como construíram sua identidade alquímica.

## 18.1 Conteúdo de uma Build Compartilhada

Uma build pode exibir:
...
- pontos fortes;
- riscos;
- origem de componentes-chave.

## 18.2 Importação de Build

O jogo pode permitir importar uma build como modelo.

Mas importação não deve conceder itens ausentes.
...
- comparação;
- guia de crafting;
- referência de loadout.

## 18.3 Builds Como Conteúdo Comunitário

Builds populares podem alimentar:
...
Isso cria engajamento sem exigir multiplayer em tempo real.

---

# 19. Economia entre Jogadores

A economia entre jogadores deve ser limitada, cuidadosa e preferencialmente mediada por instituições.

AZOTH não deve virar jogo de mercado antes de ser bom como RPG tático.

## 19.1 Princípio Econômico

Troca entre jogadores deve:

- reduzir frustração;
- apoiar cooperação;
- permitir ajuda social;
- dar uso a excedentes;
- evitar pay-to-win;
- evitar bots;
- não substituir grind;
- não destruir chase loot.

## 19.2 Recursos Trocáveis

Categorias mais seguras para troca:

- reagentes comuns;
- catalisadores básicos;
- materiais regionais comuns;
- componentes cosméticos;
- itens de evento de baixa raridade;
- suprimentos operacionais;
- receitas já conhecidas, como cópia informativa.

## 19.3 Recursos Restritos

Categorias que devem ser restritas, vinculadas ou não negociáveis:

- ultrarraros;
- Runas Irregulares;
- Artefatos Anômalos únicos;
- Fragmentos de ET de campanha;
- Protocolos Perdidos;
- materiais de revelação narrativa;
- itens vinculados ao Codex individual;
- recompensas de ranking competitivo;
- itens de progressão institucional crítica.

## 19.4 Empréstimo Temporário

Uma alternativa à troca permanente é o empréstimo temporário.

Exemplos:

- instrumento emprestado por uma operação;
- catalisador compartilhado com Célula;
- protocolo de suporte por temporada;
- slot de reforço institucional.

Empréstimo reduz barreiras sociais sem destruir economia.

## 19.5 Mercado Institucional

Se houver mercado, ele deve ser apresentado como:

- bolsa de reagentes;
- requisição acadêmica;
- arquivo de receitas;
- leilão institucional controlado;
- troca regulada por Conselho.

Isso mantém o tom do universo e permite limites sistêmicos.

---

# 20. Eventos Coletivos

Eventos coletivos são uma forma forte de live ops.

Eles permitem que todos os jogadores sintam que participam de uma crise maior, mesmo jogando solo.

## 20.1 Estrutura de Evento Coletivo

Um evento pode ter:

1. premissa narrativa sazonal;
2. região afetada;
3. tipo de Breach ou instabilidade;
4. metas individuais;
5. metas de Célula;
6. metas globais;
7. fases de progressão;
8. recompensas por contribuição;
9. desbloqueio de relatório coletivo;
10. consequência temporária ou persistente.

## 20.2 Metas Globais

Exemplos:

- estabilizar focos de Breach;
- catalogar anomalias;
- recuperar fragmentos;
- escoltar comboios;
- reconstruir matriz;
- purificar resíduos;
- reduzir pressão regional;
- completar simulações de contenção.

## 20.3 Consequências Coletivas

Eventos podem alterar temporariamente:

- disponibilidade de missões;
- custo de recursos;
- frequência de Breaches;
- mutadores regionais;
- relatos de NPCs;
- entradas do Codex sazonal;
- estética do mapa;
- loja institucional;
- desafios de endgame.

Consequências permanentes devem ser raras e planejadas.

---

# 21. Temporadas Multijogador

Temporadas conectam progressão individual, comunidade e endgame.

## 21.1 Função das Temporadas

Temporadas devem:

- renovar atividades;
- introduzir mutadores;
- destacar regiões;
- criar metas coletivas;
- oferecer chase loot sazonal;
- atualizar rankings;
- incentivar retorno;
- expandir Codex controladamente.

## 21.2 Estrutura Recomendada

Uma temporada pode conter:

- tema;
- região foco;
- família de fenômenos;
- mutadores;
- operação repetível especial;
- Frente de Colapso sazonal;
- simulação semanal;
- trilha de recompensas;
- metas de comunidade;
- relatório final.

## 21.3 Temporada e FOMO

Temporadas devem gerar desejo de participar, mas não medo destrutivo de perder.

Regras recomendadas:

- cosméticos podem ser exclusivos ou semi-exclusivos;
- poder obrigatório não deve ser exclusivo;
- chase loot sazonal pode retornar em rotação;
- Codex essencial deve ficar acessível depois;
- eventos narrativos importantes devem ser recapituláveis;
- jogadores novos não devem ser condenados por chegar tarde.

---

# 22. Rankings e Pontuação

Rankings são úteis, mas perigosos se virarem centro predatório da experiência.

## 22.1 Score Operacional

O score de uma operação pode considerar:
...
## 22.2 Score Não Deve Medir Apenas Velocidade

AZOTH não deve recompensar apenas rush.

O score deve valorizar:
...
## 22.3 Brackets de Ranking

Para evitar injustiça, rankings podem ser separados por:
...
## 22.4 Recompensas de Ranking

Recompensas devem priorizar:
...
- destaque de perfil;
- decoração de hub;
- padrão visual de círculo.

Evitar poder exclusivo de alto impacto.

---

# 23. Comunicação e Coordenação

Interação social precisa de comunicação suficiente, mas segura.

## 23.1 Comunicação Rápida

Em coop, comunicação rápida pode incluir:

- pings de célula;
- marcação de alvo;
- indicação de ET planejada;
- aviso de risco;
...
Chat livre pode ser útil, mas aumenta custo de moderação.

Para escopo inicial, recomenda-se:
...
Chat livre global não deve ser prioridade.

## 23.3 Linguagem Diegética

Comunicação pode usar linguagem do universo:
...
Isso reforça imersão e reduz ruído de UI.

---

# 24. Segurança, Toxicidade e Design Social

Multiplayer pode destruir um jogo bom se incentivar comportamento ruim.
...
- toxicidade em coop;
- elitismo de build;
- exclusão de jogadores novos;
- pressão diária;
- guildas obrigatórias;
- mercado abusivo;
- trapaça em rankings;
- meta rígido;
- FOMO;
...
## 24.2 Mitigações Sistêmicas

Mitigações recomendadas:

- solo-first;
- recompensas sociais não obrigatórias;
- matchmaking por dificuldade;
- rankings separados;
- desafios de loadout fixo;
- comunicação rápida não abusiva;
- evitar punições severas por falha alheia;
- limitar troca de itens críticos;
- registrar contribuição individual em eventos coletivos;
- permitir participação casual.

## 24.3 Jogador Casual e Jogador Hardcore

O jogo deve permitir que ambos existam.

Jogador casual deve:

- completar campanha;
- participar de eventos;
- obter recompensas úteis;
- jogar solo;
- experimentar builds sem punição severa.

Jogador hardcore deve:

- otimizar builds;
- disputar rankings;
- farmar ultrarraros;
- liderar Células;
- enfrentar Frentes profundas;
- buscar prestígio sazonal.

A diferença deve estar em profundidade e prestígio, não em acesso básico à diversão.

---

# 25. Multiplayer e Codex

O Codex é individual, mas pode ter camadas comunitárias.

## 25.1 Codex Individual

Cada jogador deve desbloquear seu próprio conhecimento essencial.

Outro jogador não pode simplesmente revelar entradas críticas antes da hora.

## 25.2 Codex Comunitário

Eventos podem ter Codex comunitário com:

- progresso global;
- registros agregados;
- hipóteses sazonais;
- relatórios coletivos;
- estatísticas de fenômeno;
- descobertas desbloqueadas por contribuição.

## 25.3 Bloqueios de Revelação

Se uma informação pertence a uma camada narrativa avançada, ela não deve aparecer em:

- relatório público de jogador iniciante;
- chat automático;
- evento sazonal inicial;
- descrição de ranking;
- tooltip de item compartilhado;
- build pública sem filtro.

O sistema deve ocultar, redigir ou substituir termos conforme progresso individual do jogador.

Exemplo:

- jogador avançado vê “Protocolo Flamel”;
- jogador inicial vê “protocolo geométrico desconhecido” ou termo autorizado pela sua camada.

---

# 26. Multiplayer e Campanha

A campanha principal deve continuar individual.

## 26.1 Por Que Campanha Não Deve Ser Coop Obrigatória

Campanha em AZOTH depende de:
...
- descobertas graduais.

Coop obrigatório poderia quebrar:
...
## 26.2 Coop em Missões Narrativas

Algumas missões secundárias ou versões repetíveis de operações narrativas podem permitir coop.

Mas a primeira experiência de marcos narrativos importantes deve ser solo ou controlada.

## 26.3 Ajuda sem Spoiler

Jogadores podem ajudar indiretamente sem revelar narrativa:
...
- relatórios redigidos.

---

# 27. Multiplayer e Endgame

O endgame é o lugar mais natural para multiplayer avançado.

Após a revelação estrutural, o mundo entra em regime de administração de consequências, cooperação maior e resposta a colapsos.

## 27.1 Endgame Autoriza Cooperação Mais Ampla

No endgame, faz sentido ter:
...
- metas de comunidade;
- raids táticas leves;
- rankings de contenção;
- pesquisas coletivas;
- desafios de Breach extrema.

## 27.2 Endgame Não Deve Virar MMO

Mesmo no endgame, AZOTH deve manter:

- operações instanciadas;
- grupos pequenos;
- clareza tática;
- buildcraft individual;
- consequência narrativa;
- limites canônicos.

## 27.3 Pós-Revelação e Linguagem

Depois de certos marcos, o jogo pode liberar termos, sistemas e descrições mais completas.

Antes disso, multiplayer deve usar terminologia compatível com a camada de revelação do jogador.

---

# 28. Matchmaking

Matchmaking, se existir, deve priorizar compatibilidade operacional, não só poder.

## 28.1 Critérios Possíveis
...
- tempo estimado;
- idioma;
- preferência por casual/hardcore.

## 28.2 Papéis no Matchmaking

Matchmaking pode sugerir composição:

- pelo menos uma função de contenção;
- pelo menos uma função de análise;
- pelo menos uma função de extração ou suporte;
- evitar redundância excessiva.

Mas não deve bloquear entrada rigidamente em toda atividade.

## 28.3 Matchmaking Assíncrono

Para suporte remoto e operações em cadeia, matchmaking pode simplesmente parear contribuições:

- jogador A envia análise;
- jogador B recebe bônus;
- ambos ganham progresso pequeno;
- sistema registra cooperação.

Isso é mais simples que coop em tempo real.

---

# 29. Operações em Cadeia

Operações em Cadeia são um formato muito compatível com desenvolvimento solo e multiplayer assíncrono.

## 29.1 Definição

Uma Operação em Cadeia é uma missão coletiva dividida em etapas, onde cada jogador conclui uma parte em sua própria instância.

Exemplo:

1. jogador A localiza foco de Breach;
2. jogador B coleta amostra;
3. jogador C executa contenção;
4. jogador D extrai resíduo;
5. célula recebe relatório consolidado.

## 29.2 Vantagens

- não exige todos online;
- cria sensação de cooperação;
- preserva jogabilidade solo;
- facilita eventos sazonais;
- permite contribuição individual;
- reduz complexidade técnica.

## 29.3 Recompensas

Recompensas podem incluir:

- bônus individual por etapa;
- bônus coletivo por conclusão;
- progresso de Célula;
- registro no Codex comunitário;
- chance de material adicional;
- título de participação.

---

# 30. Raids Táticas Leves

Raids tradicionais podem ser pesadas demais para AZOTH no início.

Se houver raids, elas devem ser “raids táticas leves”.

## 30.1 Definição

Uma raid tática leve é uma sequência curta de operações difíceis para grupo pequeno, com pontos de extração e objetivos variados.

## 30.2 Estrutura Possível
...
4. decisão de rota;
5. extração parcial;
6. segundo confronto com mutador;
7. objetivo final;
8. retirada ou colapso.

## 30.3 Escopo

Recomendação:

- máximo 3 jogadores no início;
- 20 a 40 minutos;
- checkpoints leves;
- recompensas proporcionais;
- sem obrigação semanal rígida;
...
Um hub social pode existir, mas não precisa ser espaço 3D compartilhado.

Para AZOTH, um hub social funcional é melhor que um hub visual caro.

## 31.1 Formatos Possíveis

- mural interacadêmico;
- quadro de operações;
- sala de Célula;
- arquivo compartilhado;
- laboratório de pesquisa coletiva;
- vitrine de builds;
- mapa de contribuição global;
- ranking por Academia.

## 31.2 Evitar Escopo Excessivo
...
- emotes complexos;
- decoração massiva;
- social hub obrigatório.

AZOTH precisa primeiro ser excelente em operação, tática, build e recompensa.

---

# 32. Perfis de Jogador

Perfis reforçam identidade e prestígio.

## 32.1 Elementos de Perfil
...
- build destacada;
- padrão visual de círculo;
- contribuições sazonais;
- descobertas de Codex não spoiler.

## 32.2 Perfil e Spoilers

Perfis não devem exibir termos ou conquistas que revelem camadas avançadas para jogadores que ainda não chegaram lá.
...
- filtrar visualização por progresso.

---

# 33. Contribuição sem Obrigação

Eventos sociais e multiplayer devem ser úteis, mas não obrigatórios.

## 33.1 Regra de Participação Mínima

Jogador que participa pouco deve receber algo proporcional.

Jogador que participa muito deve receber prestígio, profundidade e chance extra, mas não monopólio de poder essencial.

## 33.2 Regra de Retorno

Jogador que perdeu temporada deve conseguir retornar sem sentir que sua conta foi arruinada.

## 33.3 Regra de Comunidade Saudável

O jogo deve incentivar:
...
- coordenar;
- celebrar conquista;
- comparar desempenho sem humilhar.

---

# 34. Monetização e Multiplayer

Este documento não define modelo de monetização, mas fixa limites.

Multiplayer não deve ser usado para vender poder obrigatório.

## 34.1 Proibições de Design

Evitar:

- comprar ultrarraro competitivo;
- vender vantagem em ranking;
- vender acesso exclusivo a poder essencial;
- vender recursos que destruam grind;
- monetizar pressão social de Célula;
- criar temporada impossível sem pagamento.

## 34.2 Itens Mais Seguros

Possíveis categorias futuras mais seguras:

- cosméticos;
- padrões visuais de círculo;
- molduras de perfil;
- decoração de hub/célula;
- animações de relatório;
- trilhas visuais de ET;
- conveniência não competitiva;
- passe sazonal com recompensas não obrigatórias.

---

# 35. Viabilidade Técnica e Roadmap Recomendado

Para um projeto solo, a ordem recomendada é:

## 35.1 Fase 1 — Sem Multiplayer Real
...
- loot;
- Codex;
- endgame solo inicial;
- rankings locais ou mockados.

## 35.2 Fase 2 — Assíncrono Simples

Implementar:

- perfis;
- builds compartilháveis;
- desafios semanais com seed fixa;
- ranking básico;
- eventos globais simples;
- Células leves.

## 35.3 Fase 3 — Assíncrono Profundo
...
- pesquisa coletiva;
- suporte remoto;
- contribuições de Frente;
- Codex comunitário;
- economia limitada.

## 35.4 Fase 4 — Coop Síncrono Experimental

Implementar apenas se o jogo já provar retenção.

Começar com:

- uma operação em dupla;
- grid pequeno;
- turno compartilhado;
- sem matchmaking complexo;
- convite direto ou Célula.

## 35.5 Fase 5 — Frentes Conjuntas
...
## 35.6 Fase 6 — Competição Avançada

Apenas se houver demanda e estabilidade sistêmica.
...
- rankings avançados;
- PvP indireto;
- talvez PvP direto em simulação, se fizer sentido.

---

# 36. Regras de Não Contradição Canônica

Multiplayer deve obedecer às seguintes regras:

1. Vários jogadores representam vários agentes, não múltiplos escolhidos cosmológicos.
2. Cooperação entre jogadores não explica Sincronias Ômni-Temporais.
3. Cooperação entre jogadores não repara o Véu completamente.
4. Eventos coletivos podem administrar consequências, não apagar custo acumulado.
5. Rankings não devem transformar Verdade em troféu público para iniciantes.
6. Células não podem liberar conhecimento antes da progressão individual.
7. PvP, se existir, deve ser simulação ou exercício controlado.
8. Trocas não podem contornar progressão narrativa.
9. Coop não deve permitir transmutação impossível.
10. Frentes Conjuntas devem derivar de Breach, instabilidade, Caos ou crise institucional autorizada.
11. Jogadores não devem comercializar livremente itens que representam revelações canônicas.
12. Eventos sazonais devem respeitar regiões, Academias e limites de lore.

---

# 37. Relação com Documentos Anteriores

## 37.1 Relação com 04.0

Este documento expande a visão de gameplay sem alterar a definição de produto.

Multiplayer permanece subordinado ao RPG tático narrativo de operações alquímicas.

## 37.2 Relação com 04.1

Interação multijogador deve reforçar os loops já definidos:
...
Não cria loop obrigatório separado.

## 37.3 Relação com 04.2

Toda cooperação de ETs deve respeitar Máquina de Execução, LET, runas, Domínios, Operações, catalisadores, risco e validação.

## 37.4 Relação com 04.3

Coop síncrono deve usar a estrutura tática já estabelecida:

- grid;
- turnos;
- papéis;
- instabilidade;
- objetivos não exclusivamente letais;
- estados de campo.

## 37.5 Relação com 04.4

Operações multijogador devem ser extensões de estruturas de campo:
...
## 37.6 Relação com 04.5

Multiplayer deve valorizar build única, especialização e autoria do jogador.

Não deve forçar meta única.

## 37.7 Relação com 04.6

Economia multijogador deve respeitar raridade, crafting, chase loot, recursos restritos e limites contra trivialização.

---

# 38. Riscos de Design

## 38.1 Risco: Multiplayer Engolir o Jogo Solo

Problema: campanha vira tutorial para live service.

Mitigação:

- solo-first;
- campanha completa offline/solo quando possível;
- multiplayer opcional;
- recompensas não obrigatórias.

## 38.2 Risco: Coop Ser Técnico Demais

Problema: jogador casual evita coop.
...
## 38.3 Risco: Ranking Gerar Meta Tóxico

Problema: todos copiam uma build dominante.
...
- mutadores variados;
- loadouts fixos;
- recompensar critérios diferentes;
- balanceamento por telemetria.

## 38.4 Risco: Mercado Destruir Grind

Problema: comprar/trocar vira melhor que jogar.

Mitigação:

- restringir ultrarraros;
- vincular itens críticos;
- limitar trocas;
- usar mercado institucional;
- manter progresso por uso/pesquisa.

## 38.5 Risco: FOMO Excessivo

Problema: jogador sente obrigação, não vontade.

Mitigação:

- recompensas essenciais retornam;
- cosméticos podem ser prestígio;
- metas pessoais moderadas;
- eventos recapituláveis;
- temporadas não devem punir ausência curta.

## 38.6 Risco: Coop Quebra Revelação Narrativa

Problema: jogador avançado revela Verdade para iniciante via sistemas.

Mitigação:

- filtros de Codex;
- redaction automática;
- termos por camada de revelação;
- matchmaking por progresso para conteúdo sensível;
- spoilers ocultos em perfil.

## 38.7 Risco: PvP Dominar Balanceamento

Problema: ETs legais no PvE são nerfadas por PvP.
...
- simulação separada;
- normalização;
- balanceamento independente;
- foco em PvE e competição indireta.

## 38.8 Risco: Infraestrutura Acima da Capacidade

Problema: multiplayer complexo trava desenvolvimento solo.
...
- começar assíncrono;
- evitar MMO;
- não implementar coop síncrono antes do core solo;
- usar eventos simples inicialmente.

---

# 39. Decisões Consolidadas neste Documento

Este documento consolida as seguintes decisões:

1. AZOTH: BREACH deve ser solo-first e multiplayer-enhanced.
2. Campanha principal não deve exigir multiplayer.
3. Multiplayer inicial recomendado é assíncrono.
4. Coop síncrono é expansão futura, não base do MVP.
5. Competição deve priorizar eficiência, prestígio, simulações e score, não PvP letal.
6. PvP direto não é prioridade e, se existir, deve ser simulação controlada.
7. Células de Campo são a estrutura social recomendada.
8. Filiação acadêmica pode gerar identidade, prestígio e competição, sem aprisionar build.
9. Relatórios compartilhados, Ecos de Campo, suporte remoto e pesquisa coletiva são formas fortes de coop assíncrono.
10. Frentes Conjuntas são o principal formato coop de endgame futuro.
11. Operações em Cadeia são formato recomendado para multiplayer assíncrono profundo.
12. Rankings devem medir múltiplos critérios, não apenas velocidade ou dano.
13. Builds compartilháveis são essenciais para comunidade e retenção.
14. Importar build deve criar plano de progressão, não conceder itens.
15. Economia entre jogadores deve ser limitada e institucionalmente mediada.
16. Ultrarraros, Protocolos Perdidos, Runas Irregulares e itens de revelação devem ser restritos.
17. Eventos coletivos e temporadas devem permitir contribuição solo, de Célula e global.
18. Codex individual não pode ser substituído por Codex de outro jogador.
19. Sistemas sociais devem ocultar spoilers conforme camada de revelação.
20. Multiplayer deve reforçar grind, buildcraft, Codex e endgame sem substituir o núcleo tático narrativo.
21. Comunicação deve priorizar pings e linguagem diegética antes de chat livre.
22. Monetização futura não deve vender poder obrigatório, vantagem competitiva ou ultrarraros essenciais.
23. O roadmap deve começar por sistemas solo, depois assíncronos, depois coop experimental.

---

# 40. Pendências para Documentos Posteriores

Este documento não fecha:

- arquitetura técnica de servidores;
- netcode;
- backend;
- banco de dados;
- autenticação;
- matchmaking final;
- tamanho final de Células;
- limites exatos de troca;
- regras finais de mercado;
- duração final de temporadas;
- fórmula de score;
- categorias finais de ranking;
- moderação;
- anti-cheat;
- política de nomes;
- chat final;
- detalhes de UX de lobby;
- tela de perfil;
- UI de build compartilhada;
- recompensas finais de ranking;
- modelo de monetização;
- viabilidade real de coop síncrono;
- implementação de raids;
...
- `04.8 — Interface, UX e Legibilidade de Gameplay`;
- `04.10 — Balanceamento, Telemetria e Critérios de Validação`;
- documentação futura de tecnologia;
- documentação futura de produto/live service;
- documentação futura de monetização;
- documentação futura de comunidade e operação.

---

# 41. Princípio Final

Multiplayer em AZOTH: BREACH deve ser lembrado por uma ideia simples:

> **outros jogadores não existem para substituir sua jornada; eles existem para provar que Aletheia é maior que sua célula, que outras builds também respondem à crise e que a sobrevivência diante das Breaches exige tanto competência individual quanto cooperação limitada, tensa e significativa.**

O jogador deve sentir que sua build é dele, sua campanha é dele e seu progresso foi conquistado por esforço próprio.

Ao mesmo tempo, deve sentir que há outros agentes enfrentando o mesmo mundo instável, disputando prestígio, compartilhando descobertas, contribuindo para Frentes e provando que nenhuma Academia, Célula ou alquimista entende tudo sozinho.

O multiplayer ideal de AZOTH deve fazer o jogador pensar:

> **“Eu consigo jogar sozinho, mas fazer parte de uma resposta maior torna minhas descobertas mais relevantes.”**
<!-- FIM: docs/04_gameplay/AZOTH_04.7_Coop_Competicao_e_Interacao_Multijogador_v0.1.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.8_Interface_UX_e_Legibilidade_de_Gameplay_v1.0.md -->
...
<!-- FIM: docs/04_gameplay/AZOTH_04.8_Interface_UX_e_Legibilidade_de_Gameplay_v1.0.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.9_Codex_Investigacao_e_Narrativa_Jogavel_v1.0.md -->
# AZOTH: BREACH — Documento 04.9 — Codex, Investigação e Narrativa Jogável
## Documento de Conhecimento Jogável, Descoberta, Evidência e Progressão Narrativa

**Série:** 04 — Gameplay  
**Documento:** 04.9  
**Status:** v1.0 consolidado  
**Função:** definir como o conhecimento, a investigação, o Codex Veritatis, os relatórios de campo, as evidências, as hipóteses, as contradições, os arquivos, as revelações e a narrativa sistêmica funcionam como mecânicas jogáveis em AZOTH: BREACH.

---

# 1. Função deste Documento

Este documento define a camada jogável de conhecimento de **AZOTH: BREACH**.

Sua função é transformar a riqueza narrativa, alquímica e cosmológica do projeto em sistemas que o jogador possa usar, perseguir, interpretar, desbloquear, comparar, testar e aplicar. O universo de AZOTH não deve ser apresentado apenas por textos extensos, diálogos ou enciclopédias passivas. Ele deve ser descoberto por meio de operações, evidências, relatórios, experimentos, Codex, decisões, revisões de hipótese, contradições institucionais e consequências práticas.

Este documento responde às seguintes perguntas:

- como o Codex Veritatis funciona como sistema jogável;
- como a investigação gera progressão;
- como conhecimento vira poder sem romper o cânone;
- como a narrativa aparece dentro de missões, operações, loot, combate e crafting;
- como o jogador descobre o mundo sem receber exposição excessiva;
- como a incerteza fundamental da alquimia se manifesta em gameplay;
- como evidências, amostras, arquivos e testemunhos se conectam;
- como o jogo recompensa leitura, atenção, análise e retorno a regiões antigas;
- como preservar mistério sem deixar o jogador perdido;
- como a campanha, o grind e o endgame continuam produzindo significado narrativo.

A premissa central deste documento é:

> **em AZOTH: BREACH, conhecimento não é apenas lore; conhecimento é recurso, progressão, ferramenta, risco, recompensa e responsabilidade.**
...
11. `AZOTH_04.6_Recursos_Crafting_Pesquisa_e_Economia_de_Sistemas_v0.1.md`;
12. `AZOTH_04.7_Coop_Competicao_e_Interacao_Multijogador_v0.1.md`;
13. `AZOTH_04.8_Interface_UX_e_Legibilidade_de_Gameplay_v1.0.md`.

O sistema de investigação não pode:

- revelar Verdades estruturais antes do ponto narrativo definido;
- transformar mistério canônico em puzzle arbitrário;
- permitir que o jogador “resolva” o universo por grind infinito;
- converter conhecimento alquímico em onisciência mecânica;
- contradizer a Incerteza Fundamental da Transmutação;
- tratar o Codex como wiki externa desconectada do personagem;
- fazer o jogador conhecer informações que seu agente ainda não obteve;
- transformar Academias em meros menus de upgrades sem postura ideológica;
- reduzir Breaches, Ruído Informacional ou Véu a simples barras de progresso;
- recompensar leitura passiva mais do que investigação ativa.

O Codex, a investigação e a narrativa jogável devem manter uma regra essencial:

> **o jogador pode expandir sua compreensão operacional, mas nunca eliminar completamente a incerteza ontológica do mundo.**

---

# 3. Princípio Central

O princípio central da narrativa jogável de AZOTH: BREACH é:

> **descobrir deve mudar a forma de jogar.**

Uma informação nova não deve ser apenas um parágrafo bonito. Ela deve poder alterar:
...
- previsões de Breach;
- crafting de ETs;
- desbloqueio de pesquisas;
- escolhas de diálogo;
- reputação institucional;
- estado regional;
- recompensas possíveis;
- rotas em ruínas;
- interpretação de eventos antigos;
- estratégias de combate;
- builds viáveis;
- acesso a operações restritas;
- desfechos de campanha;
- eventos de endgame.

A pergunta de design para qualquer entrada de Codex deve ser:

> **o que esta informação permite ao jogador fazer, reconsiderar, prever, evitar, craftar, desbloquear ou questionar?**

Se a resposta for “nada”, a entrada pode existir como lore complementar, mas não deve ocupar posição de destaque na progressão jogável.

---

# 4. Fantasia de Jogador

A fantasia de jogador nesta camada é:

> **sou um alquimista de campo que reconstrói a verdade operacional do mundo por meio de evidências incompletas, relatórios contraditórios, experimentos perigosos e decisões sob incerteza.**

O jogador não é um leitor passivo do lore. Ele é parte da cadeia de produção de conhecimento.
...
Ele muda sua forma de agir.

Essa fantasia deve aparecer em todas as camadas:

- ao examinar um fenômeno no campo;
- ao escolher uma hipótese antes de uma missão;
- ao usar uma ET baseada em pesquisa anterior;
- ao ler o relatório pós-operação;
- ao desbloquear uma entrada do Codex;
- ao encontrar uma versão institucional censurada;
- ao comparar testemunho e evidência física;
- ao retornar a uma região antiga com nova interpretação;
- ao descobrir que uma explicação anterior estava incompleta.

---

# 5. O Codex Veritatis como Sistema Jogável

O **Codex Veritatis** deve funcionar como o grande sistema de conhecimento do jogo.

Ele não é apenas uma enciclopédia. Ele é:
...
- repositório de contradições;
- fonte de desbloqueios;
- medidor de compreensão regional;
- ponte entre gameplay e lore;
- memória viva da campanha.

O Codex deve ser acessível ao jogador durante a maior parte da experiência, mas suas informações não devem ser todas reveladas imediatamente. Entradas podem começar incompletas, ambíguas ou enviesadas e se tornar mais precisas conforme o jogador coleta evidências.

O Codex deve ter valor prático.

Um jogador que ignora o Codex deve ainda conseguir jogar, mas um jogador que lê, compara e entende deve jogar melhor.

---

# 6. Camadas de Informação do Codex

Cada entrada importante do Codex pode conter camadas progressivas.

## 6.1 Registro Inicial

Informação básica obtida pela primeira observação, boato, missão ou contato institucional.

Exemplo:

> “Fissuras de baixa intensidade foram registradas nos arredores de uma rota comercial.”

Essa camada apresenta o fenômeno, mas não explica causa, padrão ou utilidade.

## 6.2 Registro de Campo

Informação obtida pelo jogador em operação.
...
## 6.3 Interpretação Acadêmica

A leitura oficial de uma Academia ou especialista.

Essa camada pode ser útil, mas não necessariamente neutra.
...
Informação que não encaixa na interpretação dominante.

Essa camada é muito importante para AZOTH.

A contradição pode surgir quando:

- a evidência física contradiz relatório oficial;
- dois NPCs descrevem o mesmo fenômeno de forma diferente;
- uma ET produz efeito inesperado;
- uma ruína apresenta tecnologia impossível;
- uma criatura reage a algo que não deveria reconhecer;
- uma região muda sem causa aparente;
- um arquivo antigo usa classificação proibida;
- uma missão repetível apresenta variação rara.

A contradição não precisa resolver a trama imediatamente. Ela deve criar inquietação.

## 6.5 Hipótese Restrita

Interpretação avançada, desbloqueada por evidências suficientes, autoridade institucional, pesquisa ou momento de campanha.

Ela pode liberar:

- nova opção de diálogo;
- missão de investigação;
- variação de ET;
- acesso a arquivo;
- operação restrita;
- alerta de risco;
- modificação de build;
- entrada paralela do Codex;
- novo marcador no mapa.

## 6.6 Recontextualização

Camada desbloqueada depois de grandes revelações.

A recontextualização permite que o jogador volte a entradas antigas e perceba que elas significavam outra coisa.

Essa camada é essencial para narrativa memorável.

O jogador deve ter momentos de:

> “Agora eu entendi por que aquilo aconteceu.”

A recontextualização não deve apagar a entrada antiga. Deve preservá-la como registro histórico, mostrando a evolução do conhecimento.

---

# 7. Tipos de Entradas do Codex

O Codex deve organizar informações por categorias claras, mas interconectadas.

## 7.1 Fenômenos de Breach

Entradas sobre fissuras, anomalias, instabilidades, padrões de colapso, eventos de Ruído, distorções locais e manifestações recorrentes.

Uso jogável:

- prever objetivos de missão;
- reconhecer estados de campo;
- reduzir risco em operações futuras;
- desbloquear ETs de contenção;
- melhorar recompensas de extração;
- identificar variações raras.

## 7.2 Alquimia Aplicada

Entradas sobre ETs, Domínios, Operações, Geometrias, Runas, Catalisadores, Instrumentos, Falhas e Protocolos.

Uso jogável:

- desbloquear Engenharia de ETs;
- reduzir custo de pesquisa;
- liberar modificadores;
...
## 7.3 Regiões de Aletheia

Entradas sobre lugares, rotas, cidades, ruínas, zonas interditadas, biomas, frentes de colapso e estruturas de campo.

Uso jogável:

- revelar missões;
- alterar rotas;
- melhorar recompensas regionais;
- desbloquear contatos;
- reduzir penalidades ambientais;
- contextualizar consequências.

## 7.4 Academias e Instituições

Entradas sobre facções, escolas, departamentos, doutrinas, conflitos, permissões, censuras, protocolos e interesses.

Uso jogável:

- abrir opções de aliança;
- modificar recompensas;
- liberar pesquisas;
- alterar reputação;
- gerar conflitos de decisão;
- criar missões exclusivas.

## 7.5 Criaturas, Entidades e Organismos Alterados

Entradas sobre inimigos, formas deslocadas, organismos contaminados, criaturas adaptadas à Breach e entidades mal classificadas.

Uso jogável:

- revelar fraquezas condicionais;
- prever comportamento;
- desbloquear contenção não letal;
- melhorar coleta de amostras;
- reduzir dano recebido;
- permitir captura ou estudo.

## 7.6 Personagens e Testemunhos

Entradas sobre companheiros, NPCs, pesquisadores, civis, autoridades, sobreviventes, dissidentes e figuras históricas.

Uso jogável:

- destravar diálogos;
- alterar confiança;
- criar escolhas de missão;
- revelar contradições;
- modificar reputação;
- afetar desfechos pessoais.

## 7.7 Ruínas, Artefatos e Protocolos Perdidos

Entradas sobre estruturas antigas, artefatos, padrões de transmutação esquecidos, registros pré-acadêmicos e tecnologias anômalas.

Uso jogável:

- desbloquear puzzles;
- revelar rotas secretas;
- liberar chase loot;
- ativar Frentes de Colapso;
- craftar ETs raras;
- expandir a camada de mistério.

## 7.8 Eventos Históricos

Entradas sobre incidentes passados, guerras, catástrofes, fundações institucionais, censuras e momentos esquecidos.

Uso jogável:

- recontextualizar missões;
- explicar disputas;
- abrir investigações;
- desbloquear arquivos;
- criar decisões políticas;
- aproximar campanha e lore.

## 7.9 Relatórios do Jogador

Entradas geradas pelas ações do jogador.

Uso jogável:

- registrar decisões;
- marcar consequências;
- preservar histórico de campanha;
- comparar hipóteses;
- alimentar pesquisa;
- personalizar a narrativa.

---

# 8. Evidências como Unidades de Gameplay

A investigação deve ser construída em torno de evidências.

Evidências são objetos, registros, observações ou dados obtidos durante operações.
...
Cada evidência pode ter atributos:
...
- potencial de contradição;
- valor de crafting;
- valor narrativo.

Evidência não deve ser apenas colecionável. Ela deve alimentar sistemas.

---

# 9. O Ciclo Investigativo

O ciclo investigativo deve se repetir ao longo de toda a campanha, grind e endgame.

## 9.1 Observar

O jogador encontra algo incompleto.
...
- um documento;
- uma consequência regional.

## 9.2 Coletar

O jogador obtém evidências.
...
- usar ET correta;
- gastar recurso;
- sacrificar recompensa;
- escolher rota;
- proteger alvo;
- completar objetivo opcional;
- aceitar risco extra;
- prosseguir em uma Frente de Colapso.

## 9.3 Interpretar

O Codex atualiza hipóteses.

A interpretação pode ser automática, parcial ou exigir pesquisa no hub.

## 9.4 Aplicar

O conhecimento gera efeito jogável:

- novo modificador;
- alerta em missão;
- vantagem contra inimigo;
- opção de diálogo;
- nova rota;
...
Novas evidências podem contradizer conclusões anteriores.

O jogador percebe que o conhecimento é progressivo.

Esse ciclo deve ser claro o bastante para ser recompensador e misterioso o bastante para manter interesse.

---

# 10. Conhecimento como Recompensa

O jogo deve tratar conhecimento como categoria de recompensa tão importante quanto materiais e equipamentos.

Recompensas de conhecimento podem incluir:

- nova entrada de Codex;
- camada adicional em entrada existente;
- hipótese desbloqueada;
- contradição registrada;
- classificação de fenômeno;
- identificação de inimigo;
- fórmula parcial de ET;
- leitura de runa;
- mapa de ruína;
- relatório institucional;
- arquivo censurado;
- permissão de pesquisa;
- desbloqueio de diálogo;
- protocolo de operação;
- método de extração;
- alerta de risco futuro.

O jogador deve sentir que uma missão pode valer a pena mesmo quando o loot material não é perfeito.

Exemplo de recompensa boa:

> O jogador não obteve uma runa rara, mas descobriu que uma classe de Breach pode ser estabilizada com ETs de geometria linear. Isso reduz risco em operações futuras e abre uma pesquisa.

---

# 11. Conhecimento como Poder Horizontal

O conhecimento deve gerar principalmente poder horizontal.
...
- novas previsões;
- novas respostas;
- novas formas de reduzir risco.

O conhecimento não deve virar apenas:
...
Esses números podem existir, mas devem ser consequência secundária.

A força do conhecimento em AZOTH está em permitir que o jogador jogue de forma mais inteligente.

---

# 12. Hipóteses Jogáveis

O Codex deve permitir que certas investigações gerem hipóteses.

Uma hipótese é uma interpretação provisória que pode afetar gameplay.

Exemplo:

> Hipótese: “O Ruído Cristalino aumenta quando ETs de propagação são usadas em solo salino.”

Efeito jogável:

- o jogo passa a alertar o jogador em operações com esse perfil;
- uma missão de validação aparece;
- o jogador pode pesquisar uma adaptação;
- uma ET pode receber modificador de mitigação.

Hipóteses podem ter estados:
...
Esse sistema é uma forma elegante de transformar investigação em progressão.

---

# 13. Contradições Jogáveis

Contradições são fundamentais para a identidade de AZOTH.

Uma contradição acontece quando o jogador encontra dados que desafiam a explicação atual.

Contradições devem gerar:
...
- Uma Academia afirma que uma técnica é impossível, mas uma ruína contém sua geometria.
- Um fenômeno classificado como natural responde a símbolos artificiais.
- Uma criatura supostamente irracional evita certos círculos de transmutação.
- Um relatório oficial omite vítimas presentes em testemunhos.
- Um material coletado em Breach contém assinatura anterior à data da fissura.

Contradições não devem ser resolvidas imediatamente. Elas devem acumular tensão.

---

# 14. Relatórios Pós-Operação

Todo retorno de missão deve gerar um relatório.

O relatório pós-operação é uma tela/sistema que conecta:

- desempenho;
- loot;
- evidências;
- estado regional;
- atualizações de Codex;
- reputação institucional;
- riscos futuros;
- decisões tomadas;
- objetivos concluídos;
...
Esse relatório deve ser mais que tela de recompensa.

Ele deve fazer o jogador entender:

- o que aconteceu;
- o que mudou;
- o que foi aprendido;
- o que ainda está pendente;
- que decisão teve consequência;
- qual próxima ação faz sentido.

O relatório deve reforçar a fantasia de agente de campo.

---

# 15. Tipos de Relatório

## 15.1 Relatório de Contenção

Foco em estabilidade, risco, vítimas, Breach, falhas e custo operacional.

## 15.2 Relatório de Investigação

Foco em evidências, testemunhos, arquivos, hipóteses e Codex.

## 15.3 Relatório de Extração

Foco em materiais, amostras, catalisadores, artefatos, integridade e risco.

## 15.4 Relatório de Ruína

Foco em mapas, símbolos, puzzles, protocolos perdidos e contradições históricas.

## 15.5 Relatório de Frente de Colapso

Foco em profundidade alcançada, instabilidade acumulada, recompensas extraídas, dados raros e risco aceito.

## 15.6 Relatório Sazonal

Foco em evento temporário, contribuições, descobertas coletivas, recompensas únicas e progresso da temporada.

---

# 16. Investigação dentro das Operações

As operações devem conter momentos investigativos além de combate.

Exemplos de ações investigativas:

- examinar resíduo;
- entrevistar sobrevivente;
- comparar marcas geométricas;
- estabilizar amostra;
- escolher instrumento de leitura;
- decidir preservar ou destruir artefato;
- mapear fissura;
- interpretar sequência rúnica;
- abrir arquivo;
- rastrear criatura;
- reconstruir evento;
- avaliar risco de colapso;
- catalogar variação de Breach.

Essas ações podem aparecer como:
...
A investigação deve ser compatível com mobile-first. Ela deve ser profunda, mas não exigir interface excessivamente complexa.

---

# 17. Investigação em Combate

O combate tático também deve permitir investigação.

Exemplos:

- escanear inimigo em vez de atacar;
- coletar amostra de célula específica do grid;
- estabilizar objeto durante combate;
- observar padrão de movimento por turnos;
- impedir destruição de evidência;
- capturar criatura viva;
- usar ET não letal para preservar dados;
- manter Breach aberta por mais um turno para obter leitura melhor;
- sacrificar tempo de evacuação para registrar fenômeno.

Isso cria decisões interessantes:

> vencer rápido ou aprender mais?

> matar criatura ou capturá-la?

> fechar Breach agora ou coletar evidência rara?

> proteger civis ou recuperar arquivo?

Essas decisões tornam a narrativa sistêmica.

---

# 18. Puzzles Alquímicos

Puzzles devem existir, mas com cuidado.

Eles não devem ser quebra-cabeças abstratos desconectados do mundo. Devem representar problemas alquímicos reais.

Tipos possíveis:

- alinhar geometria de uma ET;
- estabilizar sequência de runas;
- escolher catalisador correto;
- equilibrar custo e risco;
- interpretar mapa de ruína;
- reconstruir circuito alquímico;
- isolar fonte de Ruído;
- ordenar eventos de um acidente;
- identificar falha em protocolo;
- recalibrar instrumento.

Puzzles devem recompensar conhecimento acumulado.

Um jogador que leu o Codex deve ter vantagem.

Puzzles não devem travar a campanha principal de forma frustrante. Eles podem:

- abrir recompensas melhores;
- reduzir risco;
- desbloquear rotas alternativas;
- revelar lore;
- melhorar loot;
- ativar missões ocultas.

---

# 19. Arquivos e Documentos no Jogo

Arquivos são um tipo importante de conteúdo narrativo.
...
- diagramas de ET;
- inventários de ruína.

Arquivos devem ser curtos o suficiente para leitura mobile, mas densos o bastante para carregar tom.

A regra recomendada:

- texto curto no fluxo principal;
- texto expandido opcional no Codex;
- resumo jogável sempre disponível.

O jogo não deve obrigar o jogador a ler longos documentos para entender uma ação básica. Mas deve recompensar quem lê.

---

# 20. Narrativa Ambiental

O mundo deve contar história visualmente.

Exemplos:

- círculo de transmutação quebrado no chão;
- laboratório abandonado com instrumentos preservados;
- cidade com marcas de evacuação;
- ruína com símbolos parcialmente apagados;
- planta crescendo de forma impossível perto de uma Breach;
- estrutura acadêmica construída sobre tecnologia antiga;
- barricadas recentes em região supostamente segura;
- corpos ausentes onde deveria haver vítimas;
- mapa antigo que não bate com a topografia atual;
- objeto comum deslocado para um lugar improvável.

Narrativa ambiental deve gerar entradas, pistas ou contradições no Codex quando examinada.

---

# 21. NPCs como Fontes de Conhecimento

NPCs não devem servir apenas para entregar quests.
...
Tipos de NPCs investigativos:

- pesquisador de campo;
- sobrevivente;
- funcionário de rota;
- alquimista dissidente;
- arquivista;
- agente institucional;
- civil afetado;
- especialista de Academia;
- rival acadêmico;
- contrabandista de artefatos;
- operador de contenção;
- testemunha traumatizada.

O jogador deve aprender que nem todo NPC está certo, mas muitos estão parcialmente certos.

---

# 22. Diálogo Investigativo

Diálogos devem poder mudar com base em:
...
- missão em andamento;
- hipótese validada;
- contradição descoberta.

Exemplo:

Se o jogador já encontrou marcas geométricas semelhantes em outra região, pode perguntar:

> “Esses círculos foram desenhados antes ou depois da fissura?”

Essa opção não precisa mudar todo o jogo. Ela pode liberar uma evidência, uma nova camada de Codex ou uma rota alternativa.

---

# 23. Decisões Narrativas Sistêmicas

Decisões narrativas devem estar ligadas a sistemas.

Exemplos:

- reportar tudo à Academia ou preservar informação localmente;
- entregar artefato ou estudá-lo antes;
- salvar civis ou recuperar amostra rara;
- fechar Breach imediatamente ou coletar leitura;
- publicar descoberta ou aceitar censura;
- apoiar interpretação oficial ou abrir investigação paralela;
- destruir ruína perigosa ou mantê-la para pesquisa;
- priorizar estabilidade regional ou avanço científico.
...
- loot;
- endgame;
- narrativa pessoal do agente.

A decisão ideal em AZOTH raramente deve ser “certo vs errado”. Deve ser:

> estabilidade agora vs conhecimento depois;

> segurança pública vs avanço técnico;

> verdade completa vs responsabilidade institucional;

> eficiência operacional vs custo humano;

> preservar evidência vs impedir dano imediato.

---

# 24. Narrativa da Campanha

A campanha principal deve usar o Codex como memória e motor.

A progressão narrativa pode seguir esta curva:

## 24.1 Fase Inicial — Incidentes Locais

O jogador acredita estar lidando com problemas regionais.
...
## 24.2 Fase Intermediária — Padrões Recorrentes

O jogador percebe que incidentes distantes compartilham assinaturas.
...
## 24.3 Fase Avançada — Contradição Estrutural

O jogador encontra evidências que desafiam explicações oficiais.
...
- reinterpretação de eventos;
- riscos de verdade.

## 24.4 Fase Final — Revelação e Consequência

O jogador descobre uma camada maior, mas não elimina o mistério.
...
# 25. Narrativa no Grind

O grind não deve ser narrativamente vazio.

Operações repetíveis podem gerar:
...
- mutações de fenômeno;
- padrões que só aparecem após repetição.

Isso justifica a repetição.

O jogador não está apenas farmando. Ele está acumulando experiência operacional em um mundo instável.

Exemplos:

- após várias contenções em uma região, o jogador descobre uma variação local de Breach;
- uma missão repetível pode ter chance rara de gerar testemunho importante;
- uma criatura comum pode carregar resíduo anômalo incomum;
- uma rota comercial pode revelar contrabando de catalisadores;
- uma operação simples pode abrir pista para missão de ruína.

O grind deve alimentar o Codex em pequenas doses.

---

# 26. Narrativa no Endgame

O endgame deve ser mais que conteúdo difícil.

As **Frentes de Colapso** devem produzir conhecimento extremo, raro e perigoso.

O jogador deve buscar:
...
- hipóteses pós-campanha;
- dados de colapso;
- recontextualizações avançadas;
- entradas raríssimas do Codex.

O endgame deve responder à pergunta:

> depois da grande revelação, como o mundo continua reagindo?

O jogador não deve sentir que terminou a verdade. Deve sentir que agora opera em uma escala mais perigosa.

---

# 27. Temporadas como Capítulos Investigativos

Temporadas devem ser eventos de mundo, não apenas passes de recompensa.

Cada temporada pode ter:

- fenômeno dominante;
- linha curta de investigação;
- entradas temporárias ou permanentes de Codex;
- anomalias sazonais;
- loot temático;
- missão coletiva;
...
- falhas de leitura;
- ETs instáveis;
- catalisadores alterados;
- Codex com entradas contestadas.

## 27.2 Temporada: Arquivos Lacrados
...
## 27.3 Temporada: Fendas de Umbra
...
- risco alto;
- chase loot;
- registros de campo extremos.

## 27.4 Temporada: Ruínas em Ressonância
...
Temporadas devem acrescentar pequenas verdades operacionais, não resolver mistérios estruturais fora da campanha.

---

# 28. O Codex como Progressão de Região

Cada região deve ter progresso de conhecimento.

Exemplo de estrutura:

- 0%: região desconhecida;
- 20%: riscos básicos identificados;
- 40%: fenômenos principais catalogados;
- 60%: rotas e ruínas conectadas;
- 80%: contradição regional revelada;
- 100%: relatório regional consolidado.

Essa porcentagem não deve ser apenas completismo. Ela pode desbloquear:
...
- modificadores de ET;
- arquivos restritos;
- missões de epílogo regional.

Uma região conhecida deve jogar diferente de uma região desconhecida.

---

# 29. O Codex como Progressão de Inimigo

Criaturas e fenômenos hostis devem ter níveis de compreensão.

Exemplo:

## Nível 1 — Avistamento

Nome provisório, comportamento básico, risco desconhecido.

## Nível 2 — Catalogação

Fraquezas iniciais, padrões, loot comum.

## Nível 3 — Estudo

Comportamento avançado, resistências, estados especiais.

## Nível 4 — Domínio Operacional

Opções de captura, loot raro, ETs recomendadas, contra-medidas.

## Nível 5 — Anomalia

Variações raras, contradições, conexão com campanha ou endgame.

Isso incentiva repetição sem depender apenas de drop.

---

# 30. O Codex como Progressão de ET

ETs também podem ter conhecimento associado.

Uma ET pode começar como uso básico e evoluir por pesquisa e experiência.
...
- geometria avançada;
- contradição;
- Protocolo Perdido associado;
- Padrão Ômega.

Ao usar uma ET em diferentes contextos, o jogador pode desbloquear conhecimento prático sobre ela.

Isso reforça o sentimento de domínio técnico.

---

# 31. O Codex e a Engenharia de ETs

A Engenharia de ETs deve depender de conhecimento.

O jogador não deve poder criar todas as combinações apenas por ter materiais.
...
- entrada de Codex suficiente.

Isso cria uma relação saudável:

> grind gera matéria; investigação gera entendimento; crafting transforma ambos em build.

---

# 32. Falha, Erro e Aprendizado

Falhas podem gerar conhecimento.

Quando uma ET falha, quando uma contenção dá errado ou quando uma hipótese é contestada, o jogador pode obter:

- registro de falha;
- alerta futuro;
- nova entrada de Codex;
- pesquisa de mitigação;
- modificação de ET;
- diálogo com especialista;
- consequência regional.

Mas falha não deve ser sempre recompensadora. Ela deve ser útil quando é interpretável.

Exemplo:

> Uma ET de cristalização falha em solo contaminado. O jogador perde controle da área, mas registra uma incompatibilidade útil para futuras operações.

Isso transforma frustração em aprendizado.

---

# 33. Informação Imperfeita

O jogo deve usar informação imperfeita de forma justa.

O jogador pode não saber tudo, mas deve saber o bastante para tomar decisões.

Tipos de informação:

## 33.1 Informação Conhecida

Dados confirmados e exibidos claramente.

## 33.2 Informação Estimada

Previsões com margem de incerteza.

## 33.3 Informação Contestada

Dados que possuem interpretações diferentes.

## 33.4 Informação Bloqueada

Dados ainda inacessíveis por falta de evidência ou progressão.

## 33.5 Informação Proibida

Dados existentes, mas restritos por Academia, censura ou risco narrativo.

A UI deve diferenciar essas categorias.

---

# 34. Mistério sem Confusão

AZOTH precisa de mistério, mas não pode ser confuso.

Mistério bom:

- o jogador entende o problema imediato;
- percebe que há algo maior;
- encontra pistas consistentes;
- pode formular hipóteses;
- recebe respostas parciais;
- vê consequências;
- quer continuar investigando.

Confusão ruim:

- termos demais sem função;
- revelações vagas demais;
- eventos sem causalidade aparente;
- Codex sem aplicação;
- sistemas escondidos;
- escolhas sem feedback;
- textos longos sem consequência.

A regra é:

> o jogador pode não entender a verdade total, mas deve entender por que sua próxima ação importa.

---

# 35. Revelações

Revelações devem ser preparadas por gameplay.

Uma revelação forte não deve surgir apenas em cutscene. Ela deve ser construída por:
...
Quando a revelação acontecer, o jogador deve sentir:

> “Eu poderia ter percebido.”

Não:

> “O jogo inventou isso agora.”

---

# 36. Recontextualização de Conteúdo Antigo

Após certas revelações, o jogo deve atualizar entradas antigas do Codex.
...
- marcador visual;
- nota do personagem;
- comentário de Academia;
- missão de retorno;
- alteração de mapa;
- novo objetivo em região antiga;
- interpretação alternativa de inimigo;
- desbloqueio de ruína.

Esse sistema aumenta a sensação de profundidade e reduz a necessidade de criar sempre regiões novas.

Conteúdo antigo se torna novo por compreensão nova.

---

# 37. O Jogador como Autor Parcial do Codex

O Codex deve refletir a jornada específica do jogador.

Entradas podem registrar:

- decisão tomada;
- NPC salvo ou perdido;
- Academia favorecida;
- hipótese validada primeiro;
- região estabilizada ou negligenciada;
- artefato entregue ou preservado;
- Breach fechada ou estudada;
- falha importante;
- build usada em operação crítica.

Isso torna o Codex pessoal.

Dois jogadores podem ter o mesmo cânone macro, mas Codex com histórico diferente.

---

# 38. Narrativa e Builds

Builds devem ter identidade narrativa.

Um jogador focado em contenção deve ser percebido como agente conservador, estável, técnico.

Um jogador focado em decomposição agressiva pode ser visto como eficiente, mas arriscado.

Um jogador focado em análise pode desbloquear mais conhecimento, mas talvez sofra em combate direto.

Um jogador focado em artefatos pode acessar efeitos raros, mas lidar com risco e suspeita institucional.

A narrativa não precisa julgar moralmente a build, mas deve reconhecer estilo operacional.

Exemplos:

- NPCs comentam sua abordagem;
- relatórios classificam método recorrente;
- Academias oferecem missões compatíveis;
- Codex registra assinatura de campo;
- certas investigações favorecem certas especializações.

---

# 39. Narrativa e Loot

Loot raro deve ter história.

Um item ultrarraro sem contexto perde força.

Categorias de loot narrativo:

- item com origem regional;
- catalisador ligado a evento histórico;
- runa irregular encontrada em ruína específica;
- artefato com relatório censurado;
- fragmento de ET associado a personagem antigo;
- material impossível que contradiz classificação oficial;
- instrumento de Academia rival;
- Padrão Ômega ligado a Frente de Colapso.

O chase loot deve ser desejado por poder e por significado.

---

# 40. Narrativa e Multiplayer

Mesmo em sistemas multiplayer, o conhecimento deve preservar coerência.

Coop e interações assíncronas podem gerar:

- relatórios compartilhados;
- contribuições coletivas de pesquisa;
- progresso sazonal;
- rankings de contenção;
- descobertas comunitárias controladas;
- comparação de builds;
- arquivos liberados por evento global.

Mas o multiplayer não deve permitir que um jogador entregue revelações de campanha a outro dentro do sistema oficial antes da hora.

A progressão narrativa individual deve ser respeitada.

---

# 41. UI do Codex

A interface do Codex deve ser clara, bonita e funcional.

Elementos recomendados:

- categorias principais;
- busca;
- filtros por região, Academia, Domínio, risco e status;
- marcador de entrada nova;
- marcador de contradição;
- camadas bloqueadas visíveis como lacunas;
- conexões entre entradas;
- resumo jogável;
- texto expandido;
...
- o que mudou?
- qual investigação posso seguir?

---

# 42. Mapa de Conhecimento

Além de listas, o Codex pode ter um mapa de conexões.

Esse mapa mostra relações entre:
...
Esse sistema deve ser opcional e legível.

Ele serve para jogadores que gostam de investigação profunda.

No mobile, pode aparecer como grafo simples, linhas de relação ou painel de “conexões relacionadas”.

---

# 43. Marcadores de Investigação

O jogo deve usar marcadores claros:

- **Novo Registro**: entrada criada.
- **Evidência Adicionada**: item anexado a entrada.
- **Hipótese Formulada**: nova interpretação possível.
- **Contradição Detectada**: dado conflitante.
- **Pesquisa Disponível**: pode ser estudado no hub.
- **Aplicação Desbloqueada**: efeito jogável liberado.
- **Recontextualização**: entrada antiga mudou de significado.
- **Arquivo Restrito**: informação bloqueada por permissão.
- **Campo Incompleto**: mais evidência necessária.

Esses marcadores devem ser consistentes em UI, relatório e mapa.

---

# 44. Onboarding da Investigação

O jogador deve aprender o sistema de conhecimento gradualmente.

## 44.1 Primeira Operação

Ensina:

- observar;
- coletar evidência;
- receber entrada de Codex;
- ver relatório.

## 44.2 Primeira Contradição

Ensina:

- registros podem estar incompletos;
- NPCs podem discordar;
- Codex atualiza hipótese.

## 44.3 Primeira Aplicação

Ensina:

- conhecimento desbloqueia vantagem prática.

## 44.4 Primeira Recontextualização

Ensina:

- eventos antigos podem ganhar novo significado.

O jogo deve evitar despejar o Codex inteiro no começo.

---

# 45. Métricas de Conhecimento

Métricas possíveis:

- Conhecimento Regional;
- Catalogação de Fenômenos;
- Compreensão de Inimigo;
- Pesquisa de ET;
- Evidências Coletadas;
- Contradições Ativas;
- Hipóteses Validadas;
- Arquivos Restritos Acessados;
- Relatórios Consolidados;
- Recontextualizações Desbloqueadas.

Essas métricas devem ser usadas para progressão, mas não precisam virar todas barras visíveis. Algumas podem existir internamente.

---

# 46. Recompensas por Completismo

Completismo deve existir, mas não ser obrigatório.
...
- arquivos raros;
- instrumentos de análise;
- modificadores de baixo impacto;
- conquistas;
- diálogo especial.

Completismo não deve bloquear final principal.

Mas deve recompensar jogadores obcecados pelo universo.

---

# 47. Evitar Excesso de Texto

AZOTH tem universo rico, mas o jogo não pode virar livro.

Regras:

- informação essencial deve ser curta;
- texto longo deve ser opcional;
- cada entrada deve ter resumo prático;
- diálogos devem ter propósito;
- arquivos devem ser densos, não verborrágicos;
- missões devem mostrar antes de explicar;
- Codex deve organizar, não soterrar.

O jogador deve poder jogar em sessões curtas sem se perder.

---

# 48. Exemplos de Entrada de Codex

## 48.1 Fenômeno de Breach — Fissura Salina

**Registro Inicial:**  
Fissuras observadas em áreas com alta concentração mineral.

**Registro de Campo:**  
ETs de propagação aumentaram instabilidade em solo salino.

**Interpretação Acadêmica:**  
Classificada como reação de condução mineral anômala.

**Contradição:**  
A fissura reagiu a geometria anterior à ativação da Breach.

**Aplicação Jogável:**  
Desbloqueia alerta de risco em operações salinas e pesquisa de mitigação.

## 48.2 Criatura — Organismo Cristalizado Errante

**Registro Inicial:**  
Entidade agressiva encontrada em zona instável.

**Catalogação:**  
Move-se em direção a fontes de calor alquímico.

**Estudo:**  
Pode ser contida com cristalização reversa se estiver isolada.

**Aplicação Jogável:**  
Permite captura não letal e loot de amostra intacta.

## 48.3 Artefato — Compasso de Campo Quebrado

**Registro Inicial:**  
Instrumento danificado encontrado em ruína.

**Análise:**  
Parece recalcular geometria com base em instabilidade local.

**Contradição:**  
O mecanismo usa notação anterior à padronização acadêmica.

**Aplicação Jogável:**  
Desbloqueia missão de reconstrução e possível instrumento raro.

---

# 49. Integração com Hub

O hub deve ser o lugar onde conhecimento é processado.
...
O hub transforma ação de campo em progressão.

Sem essa etapa, o jogo vira sequência de missões sem reflexão.

---

# 50. Laboratórios e Arquivos

O hub pode conter áreas funcionais:

## 50.1 Laboratório de Análise

Processa amostras e evidências materiais.

## 50.2 Arquivo Acadêmico

Consulta documentos, laudos e registros institucionais.

## 50.3 Sala de Cartografia

Conecta regiões, rotas, ruínas e Frentes.

## 50.4 Oficina de ETs

Aplica conhecimento em Engenharia de ETs.

## 50.5 Conselho ou Departamento

Apresenta decisões institucionais, reputação e dilemas.

## 50.6 Codex Veritatis

Centro de memória e progressão de conhecimento.

---

# 51. Decisões de Divulgação

O jogador pode precisar decidir o que fazer com informações sensíveis.

Opções possíveis:

- reportar integralmente;
- reter temporariamente;
- enviar a uma Academia específica;
- publicar parcialmente;
- proteger testemunha;
- destruir evidência perigosa;
- usar evidência em pesquisa própria;
- confrontar autoridade;
- aceitar censura.
...
Esse sistema deve ser usado com parcimônia em momentos importantes.

---

# 52. Verdade, Censura e Responsabilidade

O tema de AZOTH exige tratar conhecimento com peso.

Nem toda verdade deve ser imediatamente libertadora.

Algumas informações podem:

- causar pânico;
- atrair exploração;
- gerar corrida por artefatos;
- desestabilizar regiões;
- fortalecer facções perigosas;
- comprometer inocentes;
- abrir riscos de Breach;
- aumentar conflito entre Academias.

O jogador deve lidar com a pergunta:

> saber é sempre melhor do que não saber?

O jogo não precisa dar resposta única. Ele deve fazer a pergunta doer.

---

# 53. A Memória do Mundo

O mundo deve lembrar descobertas do jogador.

Exemplos:

- uma região adota protocolo baseado em sua pesquisa;
- NPCs citam relatório anterior;
- uma Academia usa descoberta para fins questionáveis;
- um erro de classificação gera missão de correção;
- uma técnica criada pelo jogador aparece como recomendação;
- uma decisão de censura retorna depois;
- uma ruína antiga é reinterpretada após nova evidência.

Isso faz a narrativa parecer viva.

---

# 54. Escopo Viável para Desenvolvimento Solo

Este sistema deve ser planejado com escopo controlado.

Para MVP, recomenda-se:

- Codex com categorias principais;
- entradas por camadas simples;
- atualizações automáticas pós-missão;
- evidências como itens de inventário/relatório;
- 1 região com progresso de conhecimento;
- 1 tipo de contradição;
- 1 hipótese jogável;
- 1 aplicação prática de conhecimento em ET;
- 1 recontextualização pequena;
- relatórios pós-operação claros;
- arquivos curtos.

Não é necessário criar grafo complexo, IA narrativa procedural ou centenas de entradas no início.

O essencial é provar que:

> investigar muda como o jogador joga.

---

# 55. Roadmap de Implementação Recomendado

## 55.1 Fase 1 — Codex Básico
...
## 55.2 Fase 2 — Evidências e Relatórios
...
## 55.3 Fase 3 — Hipóteses e Aplicações

- hipóteses desbloqueáveis;
- efeitos em missão;
- ligação com ETs;
- desbloqueio de pesquisa.

## 55.4 Fase 4 — Contradições e Recontextualização

- entradas contestadas;
- arquivos restritos;
- eventos de retorno;
- atualização de conteúdo antigo.

## 55.5 Fase 5 — Endgame e Temporadas

- entradas sazonais;
- Frentes de Colapso;
- registros raros;
- chase knowledge;
- descobertas coletivas controladas.
...
Risco: o Codex vira enciclopédia ignorada.

Mitigação: toda entrada importante deve ter aplicação, pista ou progressão.

## 56.2 Excesso de Texto

Risco: o jogador se cansa.

Mitigação: resumo prático, texto opcional e narrativa ambiental.

## 56.3 Mistério Confuso

Risco: o jogador não entende o que está acontecendo.

Mitigação: objetivos claros, mistério em camadas e feedback pós-missão.

## 56.4 Conhecimento Forte Demais

Risco: investigação elimina incerteza e trivializa sistemas.

Mitigação: conhecimento reduz risco, mas não remove custos fundamentais.

## 56.5 Contradições Sem Resolução

Risco: pistas parecem buracos de roteiro.

Mitigação: cada contradição importante deve ter caminho de desenvolvimento.

## 56.6 FOMO Narrativo

Risco: temporada contém informação essencial perdida para sempre.

Mitigação: temporada pode ter recompensas únicas, mas lore essencial deve retornar por arquivos permanentes.

## 56.7 Grind sem Significado

Risco: missões repetíveis viram farm vazio.

Mitigação: microevidências, variações raras, progresso regional e relatórios.

---

# 57. Critérios de Qualidade

A camada de Codex, investigação e narrativa jogável é bem-sucedida quando:

- o jogador entende que conhecimento é progresso;
- missões geram perguntas e respostas parciais;
- o Codex é consultado voluntariamente;
- novas informações mudam decisões;
- o grind pode gerar descobertas pequenas;
- o endgame continua revelando dados raros;
- builds se conectam a conhecimento acumulado;
- regiões antigas ganham novo sentido;
- NPCs e Academias parecem ter perspectivas próprias;
- revelações parecem preparadas;
- mistério gera curiosidade, não confusão;
- o jogador sente que seu agente participou da construção da verdade operacional.
...
1. O Codex Veritatis será sistema jogável, não apenas enciclopédia.
2. Conhecimento será uma categoria de recompensa.
3. Evidências serão unidades de gameplay.
4. Entradas importantes terão camadas progressivas.
5. Contradições serão mecânica narrativa recorrente.
6. Hipóteses poderão desbloquear aplicações práticas.
7. Relatórios pós-operação conectarão missão, loot, conhecimento e consequência.
8. Investigar poderá ocorrer em exploração, combate, hub e endgame.
9. O grind poderá gerar microdescobertas e progresso de Codex.
10. Temporadas poderão funcionar como capítulos investigativos controlados.
11. O Codex poderá registrar escolhas específicas do jogador.
12. Conhecimento ampliará possibilidades, mas não eliminará incerteza fundamental.
13. Recontextualização será usada para tornar conteúdo antigo relevante.
14. O sistema será implementado em fases, começando por Codex básico e relatórios.

---

# 59. Pendências para Documentos Futuros

Este documento não define em detalhe:

- conteúdo final de todas as entradas do Codex;
- árvores completas de hipótese;
- textos finais de arquivos;
- personagens específicos associados a cada investigação;
- fórmulas de progresso de conhecimento;
- UI final do grafo de relações;
- número de evidências por missão;
- quantidade de contradições por região;
- estrutura final de temporada;
- integrações técnicas com banco de dados;
- localização e tradução final;
- roteiro definitivo da campanha.

Esses pontos devem ser detalhados em documentos de narrativa, conteúdo, UI, missões, regiões e implementação.

---

# 60. Síntese Final

A camada de Codex, investigação e narrativa jogável é um dos principais diferenciais de AZOTH: BREACH.

O jogo não deve apenas contar ao jogador que o mundo é complexo. Deve fazer o jogador operar dentro dessa complexidade.

O jogador deve entrar em campo, observar fenômenos, coletar evidências, formular hipóteses, registrar contradições, aplicar conhecimento, revisar interpretações, construir ETs melhores, tomar decisões mais informadas e descobrir que cada resposta abre novas responsabilidades.

O Codex Veritatis deve ser a memória viva desse processo.

Em AZOTH: BREACH, a verdade não é um prêmio entregue no fim da campanha.

A verdade é uma ferramenta incompleta, perigosa e progressiva que o jogador aprende a usar.
<!-- FIM: docs/04_gameplay/AZOTH_04.9_Codex_Investigacao_e_Narrativa_Jogavel_v1.0.md -->

<!-- INICIO: docs/04_gameplay/AZOTH_04.10_Balanceamento_Telemetria_e_Criterios_de_Validacao_v0.1.md -->
...
<!-- FIM: docs/04_gameplay/AZOTH_04.10_Balanceamento_Telemetria_e_Criterios_de_Validacao_v0.1.md -->
