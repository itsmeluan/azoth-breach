...
/docs
  /00_constituicao
    ...
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.38.md
  /01_alquimia
  ...
  /05_produto
    ...
    AZOTH_05.12_Milestones_de_Implementacao_da_Vertical_Slice_v0.1.md
    README.md
  /98_consolidados_gpt
    README.md
...
13. 05.12 — Milestones de Implementação da Vertical Slice: agrupamento do backlog em marcos reais de execução e definição dos passos restantes até o início do desenvolvimento.
