...
/docs
  /00_constituicao
    AZOTH_00.0_Leis_Fundamentais_v1.0.md
    AZOTH_00.1_The_Truth_v1.1_Constituicao_do_Universo.md
    AZOTH_00.2_Glossario_Canonico_v1.1.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.0.md
...
Abrange tratados de alquimia, física aplicada, sistemas de transmutação, materiais, energia, biomodificação, artefatos, pesquisa científica e documentos de engenharia de sistemas.
...
| 02 — Tratado de Alquimia | `/docs/01_tratados_tecnicos` |
