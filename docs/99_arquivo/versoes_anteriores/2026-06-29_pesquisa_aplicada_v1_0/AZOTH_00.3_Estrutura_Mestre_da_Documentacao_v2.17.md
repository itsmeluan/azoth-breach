...
/docs
  /00_constituicao
    ...
    AZOTH_00.2_Glossario_Canonico_v1.18.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.17.md
  /01_alquimia
    ...
    AZOTH_01.3_Academias_de_Alquimia_v1.0.md
    AZOTH_01.4_Pesquisa_Aplicada_e_Catalogacao_Alquimica_v0.2.md
    README.md
  /02_lore
    README.md
  /03_narrativa
...
5. 01.4 — Pesquisa Aplicada e Catalogação Alquímica: protocolização de catalogação, validação, registro, preservação e governança interacadêmica de ETs a partir da base institucional das Academias.
...
| 04 — Compêndio das Academias | `/docs/02_lore` e `/docs/01_alquimia/AZOTH_01.3_Academias_de_Alquimia_v1.0.md` |
