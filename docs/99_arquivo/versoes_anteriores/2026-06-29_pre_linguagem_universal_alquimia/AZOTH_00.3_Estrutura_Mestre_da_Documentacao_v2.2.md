...
/docs
  /00_constituicao
    AZOTH_00.0_Leis_Fundamentais_v1.2.md
    AZOTH_00.1_The_Truth_v1.3_Constituicao_do_Universo.md
    AZOTH_00.2_Glossario_Canonico_v1.3.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.2.md
  /01_tratados_tecnicos
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.1.md
    README.md
  /02_lore
    README.md
  /03_narrativa
...
Abrange a Máquina Abstrata da Alquimia, futuros tratados de alquimia, física aplicada, sistemas de transmutação, materiais, energia, biomodificação, artefatos, pesquisa científica e documentos de engenharia de sistemas.

O Documento 01.0 — Máquina Abstrata da Alquimia possui precedência técnica sobre o futuro Tratado da Alquimia. A MAA define como a alquimia funciona. O Tratado da Alquimia definirá como essa estrutura é estudada pelas civilizações.
