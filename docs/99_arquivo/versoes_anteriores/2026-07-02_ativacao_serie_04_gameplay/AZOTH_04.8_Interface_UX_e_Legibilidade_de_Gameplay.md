...
Este documento prepara o terreno para `04.9_Balanceamento_Telemetria_e_Criterios_de_Validacao.md`.

O `04.9` deverá transformar princípios de UX, progressão, combate, loot e endgame em métricas, hipóteses de teste, telemetria e critérios de ajuste.
