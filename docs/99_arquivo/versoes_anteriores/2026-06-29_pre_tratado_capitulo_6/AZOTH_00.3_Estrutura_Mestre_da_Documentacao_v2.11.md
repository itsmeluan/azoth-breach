...
/docs
  /00_constituicao
    ...
    AZOTH_00.2_Glossario_Canonico_v1.12.md
    AZOTH_00.3_Estrutura_Mestre_da_Documentacao_v2.11.md
  /01_alquimia
    AZOTH_01.0_Maquina_Abstrata_da_Alquimia_v0.7.md
    AZOTH_01.1_Tratado_da_Alquimia_v0.7.md
    AZOTH_01.2_Engenharia_dos_Circulos_v0.1.md
    AZOTH_01.3_Taxonomia_das_Transmutacoes_v0.1.md
...
2. 01.1 — Tratado da Alquimia: ciência, engenharia e arquitetura das ETs.
3. 01.2 — Engenharia dos Círculos: projeto, otimização e composição de especificações.
4. 01.3 — Taxonomia das Transmutações: classificação formal das operações e técnicas.
...
| Tratado da Alquimia | `/docs/01_alquimia/AZOTH_01.1_Tratado_da_Alquimia_v0.7.md`, subordinado à MAA |
