...
2. `AZOTH_01.1_Tratado_da_Alquimia_v0.7.md`
3. `AZOTH_01.2_Engenharia_dos_Circulos_v0.1.md`
4. `AZOTH_01.3_Taxonomia_das_Transmutacoes_v0.1.md`
...
Ciência, engenharia e arquitetura das ETs.

Deve descrever como a alquimia é estudada, descrita, ensinada e aplicada pelas civilizações, incluindo arquitetura, avaliação e evolução de ETs, sem redefinir a MAA.
...
Deve organizar tipos de transmutação, famílias técnicas e padrões de aplicação a partir dos Domínios, Operações e Modificadores definidos pela MAA.
