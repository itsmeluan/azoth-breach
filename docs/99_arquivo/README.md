...
Pasta destinada a documentos históricos, versões antigas, fontes originais e materiais supersedidos.

Conteúdo inicial:

- `the_truth_v0.1_partes`: conversões Markdown históricas das cinco partes originais de The Truth v0.1.
